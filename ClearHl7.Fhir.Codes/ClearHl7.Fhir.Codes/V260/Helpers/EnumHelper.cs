...
namespace ClearHl7.Fhir.Codes.V260.Helpers
{
    ...
    public class EnumHelper : IEnumHelper
    {
        ...
        public string ValueToCode(ContainerCondition input)
        {
            return input switch
            {
                ContainerCondition.NoSuggestedValues => "...",
                _ => throw new NotImplementedException()
            };
        }
        ...
        public string ValueToCode(DataTypes input)
        {
            return input switch
            {
                ...
                DataTypes.CompositeIdNumberAndNameSimplified => "CNS",
        ...
        public string ValueToCode(SegmentGroup input)
        {
            return input switch
            {
                ...
                SegmentGroup.EncodedOrderDeprecated => "ENCODED ORDER",
                ...
                SegmentGroup.FinancialCommonOrderDeprecated => "FINANCIAL_COMMON ORDER",
                ...
                SegmentGroup.FinancialTimingQuantityDeprecated => "FINANCIAL_TIMING QUANTITY",
                SegmentGroup.FinancialTimingQuantity => "FINANCIAL_TIMING_QUANTITY",
                SegmentGroup.GeneralResourceDeprecated => "GENERAL RESOURCE",
                ...
                SegmentGroup.LocationResourceDeprecated => "LOCATION RESOURCE",
                ...
                SegmentGroup.PatientVisitDeprecated => "PATIENT VISIT",
                ...
                SegmentGroup.PersonnelResourceDeprecated => "PERSONNEL RESOURCE",
        ...
        /// <summary>
        /// Converts the given SequenceCondition enum value into its HL7 equivalent code.
        /// </summary>
        /// <param name="input">An enum value to convert.</param>
        /// <returns>A string.</returns>
        public string ValueToCode(SequenceCondition input)
        {
            return input switch
            {
                SequenceCondition.RepeatingCycleOfOrders => "C",
                SequenceCondition.ReservedForPossibleFutureUse => "R",
                SequenceCondition.SequenceConditions => "S",
                _ => throw new NotImplementedException()
            };
        }
        ...
        public string ValueToCode(SpecimenType input)
        {
            return input switch
            {
                SpecimenType.NoSuggestedValues => "...",
