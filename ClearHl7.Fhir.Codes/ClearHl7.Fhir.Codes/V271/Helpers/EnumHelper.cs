...
namespace ClearHl7.Fhir.Codes.V271.Helpers
{
    /// <summary>
    ...
    public class EnumHelper : IEnumHelper
    {
        ...
        public string ValueToCode(AlertLevel input)
        {
            return input switch
            {
                ...
                AlertLevel.NullNoLevelChangeBDeprecated => "...",
                _ => throw new NotImplementedException()
            };
        }
        ...
        public string ValueToCode(CodingSystem input)
        {
            return input switch
            {
                ...
                CodingSystem.Active => "General code",
        ...
        public string ValueToCode(EquipmentState input)
        {
            return input switch
            {
                ...
                EquipmentState.NullNoStateChangeBDeprecated => "...",
                _ => throw new NotImplementedException()
            };
        }
        ...
        public string ValueToCode(LocalRemoteControlState input)
        {
            return input switch
            {
                ...
                LocalRemoteControlState.NullNoStateChangeBDeprecated => "...",
                _ => throw new NotImplementedException()
            };
        }
        ...
        public string ValueToCode(OccurrenceCode input)
        {
            return input switch
            {
                ...
                OccurrenceCode.UseNubcCodesDeprecated => "...",
                _ => throw new NotImplementedException()
            };
        }
        ...
        public string ValueToCode(RelevantClinicialInformation input)
        {
            return input switch
            {
                ...
                RelevantClinicialInformation.FastingNotAskedOfThePatient => "FNA",
        ...
        public string ValueToCode(SubtypeOfReferencedData input)
        {
            return input switch
            {
                ...
                SubtypeOfReferencedData.SourceRfc2046BDeprecated => "...",
                _ => throw new NotImplementedException()
            };
        }
        ...
        public string ValueToCode(ValueCode input)
        {
            return input switch
            {
                ...
                ValueCode.SeeNubcCodesBDeprecated => "...",
                _ => throw new NotImplementedException()
            };
        }
