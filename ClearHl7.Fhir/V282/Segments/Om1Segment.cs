    ...
    public class Om1Segment : ISegment
    {
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                ...
                                GenderRestriction != null ? string.Join("~", GenderRestriction.Select(x => x.ToDelimitedString())) : null,
                                AgeRestriction != null ? string.Join("~", AgeRestriction.Select(x => x.ToDelimitedString())) : null
                                ).TrimEnd('|');
        }
    }
}