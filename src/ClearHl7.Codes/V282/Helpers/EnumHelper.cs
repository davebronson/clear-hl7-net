...
namespace ClearHl7.Codes.V282.Helpers
{
    ...
    public class EnumHelper : IEnumHelper
    {
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeArmStick input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeBloodUnitType input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeBolusType input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeCertificationCategoryCode input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeCertificationTypeCode input) => EnumToCode(input);
        ...
        public static string EnumToCode(CodeCodingSystem input)
        {
            return input switch
            {
                ...
                CodeCodingSystem.Hl7Version3ActcodeValues => "ACTCODE",
                CodeCodingSystem.FilteredSubset => "ACTRELSS",
                ...
                CodeCodingSystem.GermanAlphaIdV2012 => "ALPHAID2012",
                CodeCodingSystem.GermanAlphaIdV2013 => "ALPHAID2013",
                CodeCodingSystem.GermanAlphaIdV2014 => "ALPHAID2014",
                CodeCodingSystem.GermanAlphaIdV2015 => "ALPHAID2015",
                CodeCodingSystem.GermanAlphaIdV2016 => "ALPHAID2016",
                CodeCodingSystem.AustralianMedicinesTerminologyV2 => "AMTv2",
                ...
                CodeCodingSystem.VisBarCodesIis => "cdcgs1vis",
                CodeCodingSystem.CdcMethodsInstrumentsCodes => "CDCM",
                CodeCodingSystem.CdcNationalHealthcareSafetyNetworkCodes => "CDCNHSN",
                ...
                CodeCodingSystem.EducationLevel => "EDLEVEL",
                CodeCodingSystem.EntityCode => "ENTITYCODE",
                CodeCodingSystem.EntityHandlingCode => "ENTITYHDLG",
                CodeCodingSystem.EnzymeCodes => "ENZC",
                CodeCodingSystem.EpaSrs => "EPASRS",
                CodeCodingSystem.FdaUniqueDeviceIdentifier => "FDAUDI",
                ...
                CodeCodingSystem.Gs1UniqueDeviceIdentifier => "GS1UDI",
                ...
                CodeCodingSystem.HibccUniqueDeviceIdentifier => "HIBUDI",
                ...
                CodeCodingSystem.HealthcareServiceLocation => "HSLOC",
                CodeCodingSystem.Icd10 => "I10",
                CodeCodingSystem.Icd10ClinicalModification => "I10C",
                ...
                CodeCodingSystem.Isbt128StandardTransfusionTransplantationDataItems => "IBT0001",
                CodeCodingSystem.Isbt128Codes => "IBTnnnn",
                CodeCodingSystem.Ichppc2 => "IC2",
                CodeCodingSystem.IccbbaUniqueDeviceIdentifier => "ICCUDI",
                ...
                CodeCodingSystem.Icd10GermanyV2012 => "ICD10GM2012",
                CodeCodingSystem.Icd10GermanyV2013 => "ICD10GM2013",
                CodeCodingSystem.Icd10GermanyV2014 => "ICD10GM2014",
                CodeCodingSystem.Icd10GermanyV2015 => "ICD10GM2015",
                CodeCodingSystem.Icd10GermanyV2016 => "ICD10GM2016",
                ...
                CodeCodingSystem.Icf => "ICF",
                CodeCodingSystem.Iccs => "ICS",
                CodeCodingSystem.Icsd => "ICSD",
                CodeCodingSystem.LaboratoryAnalyticalWorkflowCode => "IHELAW",
                ...
                CodeCodingSystem.Langual => "LANGUAL",
                ...
                CodeCodingSystem.MimeMediaTypeIana => "MEDIATYPE",
                ...
                CodeCodingSystem.ObservationMethodCode => "OBSMETHOD",
                ...
                CodeCodingSystem.OpsGermanyV2012 => "OPS2012",
                CodeCodingSystem.OpsGermanyV2013 => "OPS2013",
                CodeCodingSystem.OpsGermanyV2014 => "OPS2014",
                CodeCodingSystem.OpsGermanyV2015 => "OPS2015",
                CodeCodingSystem.OpsGermanyV2016 => "OPS2016",
                CodeCodingSystem.SourceOfPaymentTypology => "PHDSCSOPT",
                ...
                CodeCodingSystem.PaticipationModeCode => "PRTCPTNMODE",
                CodeCodingSystem.ReadClassification => "RC",
                CodeCodingSystem.UsedInitiallyForContactRoles => "ROLECLASS",
                CodeCodingSystem.ParticipationMode => "ROLECODE",
                CodeCodingSystem.ModeByWhichReceiverShouldCommunicateResponsibilities => "RSPMODE",
                ...
                CodeCodingSystem.USBoardOnGeographicNames => "USGSGNIS",
                CodeCodingSystem.UnitedStatesPostalService => "USPS",
                CodeCodingSystem.VaccineInformationSheet => "VIS",
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeCumulativeDosageLimitUom input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeExclusiveTest input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeIntendedProcedureType input) => EnumToCode(input);
        ...
        public static string EnumToCode(CodeInterpretationCodes input)
        {
            return input switch
            {
                ...
                CodeInterpretationCodes.HoldForMedicalReview => "HM",
                CodeInterpretationCodes.VeryHigh => "HU",
                CodeInterpretationCodes.Intermediate => "I",
                CodeInterpretationCodes.InsufficientEvidence => "IE",
                CodeInterpretationCodes.Indeterminate => "IND",
                CodeInterpretationCodes.Low => "L",
                CodeInterpretationCodes.CriticallyLow => "LL",
                CodeInterpretationCodes.VeryLow => "LU",
                ...
                CodeInterpretationCodes.NonSusceptible => "NS",
                CodeInterpretationCodes.NoRangeDefinedOrNormalRangesDontApply => "null",
                CodeInterpretationCodes.InterpretationQualifiersInSeparateObxSegments => "OBX",
                ...
                CodeInterpretationCodes.SusceptibleDoseDependent => "SDD",
                CodeInterpretationCodes.SynergyResistant => "SYN-R",
                CodeInterpretationCodes.SynergySusceptible => "SYN-S",
        ...
        public static string EnumToCode(CodeNameType input)
        {
            return input switch
            {
                CodeNameType.NoSuggestedValuesDefined => "...",
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodePcaType input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodePhlebotomyIssue input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodePhlebotomyStatus input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodePreferredSpecimenAttributeStatus input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeProcessInterruption input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeProcessInterruptionReason input) => EnumToCode(input);
        ...
        /// <inheritdoc/>
        string IEnumHelper.EnumToCode(CodeRootCause input) => EnumToCode(input);
