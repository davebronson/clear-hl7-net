    ...
    public class EnumHelper : IEnumHelper
    {
        ...
        public string EnumToCode(CodeMessageStructure input)
        {
            return input switch
            {
                ...
                CodeMessageStructure.QnnDeprecated => "QBP_Qnn",
                CodeMessageStructure.Z73Deprecated => "QBP_Z73",
                ...
                CodeMessageStructure.Z82Deprecated => "RSP_Z82",
                CodeMessageStructure.Z86Deprecated => "RSP_Z86",
                CodeMessageStructure.Z88Deprecated => "RSP_Z88",
                CodeMessageStructure.Z90Deprecated => "RSP_Z90",
                CodeMessageStructure.K13 => "RTB_K13",
                CodeMessageStructure.KnnDeprecated => "RTB_Knn",
                CodeMessageStructure.Z74Deprecated => "RTB_Z74",
