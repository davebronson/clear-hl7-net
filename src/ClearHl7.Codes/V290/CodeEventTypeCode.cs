namespace ClearHl7.Codes.V290
{
    ...
    public enum CodeEventTypeCode
    {
        ...
        /// <summary>
        /// K33 - Get Donor Record Candidates Response Message.
        /// </summary>
        GetDonorRecordCandidatesResponseMessage,

        /// <summary>
        /// K34 - Segment Pattern Response Message.
        /// </summary>
        ...
        /// <summary>
        /// M18 - MFN/MFK - Master file notification - Test/Observation (Payer).
        /// </summary>
        ...
        /// </summary>
        GeneralOrderMessageWithDocumentAcknowledgement,

        /// <summary>
        /// O44 - Donor Registration - Minimal Message.
        /// </summary>
        DonorRegistrationMinimalMessage,

        /// <summary>
        /// O45 - Donor Eligibility Observations Message.
        /// </summary>
        DonorEligibilityObservationsMessage,

        /// <summary>
        /// O46 - Donor Eligiblity Message.
        /// </summary>
        DonorEligiblityMessage,

        /// <summary>
        /// O47 - Donor Request to Collect Message.
        /// </summary>
        DonorRequestToCollectMessage,

        /// <summary>
        /// O48 - Donation Procedure Message.
        /// </summary>
        DonationProcedureMessage,

        /// <summary>
        /// O49 - Pharmacy/Treatment Dispense Request Message.
        /// </summary>
        PharmacyTreatmentDispenseRequest,

        /// <summary>
        /// O50 - Pharmacy/Treatment Encoded Order Acknowledgment.
        /// </summary>
        PharmacyTreatmentEncodedOrderAcknowledgment,

        /// <summary>
        /// O51 - OSU â€“ Order Status Update.
        /// </summary>
        OsuOrderStatusUpdate,

        /// <summary>
        /// O52 - OSU â€“ Order Status Update Acknowledgement.
        /// </summary>
        OsuOrderStatusUpdateAcknowledgement,

        /// <summary>
        /// O53 - ORL - General Laboratory Order Acknowledgment Message (Patient Optional).
        /// </summary>
        OrlGeneralLabOrderAcknowledgment,

        /// <summary>
        /// O54 - ORL - Laboratory Order Acknowledgment Message - Multiple Order Per Specimen (Patient Optional).
        /// </summary>
        OrlLabOrderAcknowledgmentMultipleOrderPerSpecimen,

        /// <summary>
        /// O55 - ORL - Laboratory Order Acknowledgment Message - Multiple Order Per Container of Specimen (Patient Optional).
        /// </summary>
        OrlLabOrderAcknowledgmentMultipleOrderPerContainerOfSpecimen,

        /// <summary>
        /// O56 - ORL - Specimen Shipment Centric Laboratory Order Acknowledgment Message (Patient Optional).
        /// </summary>
        OrlSpecimenShipmentCentricLabOrderAcknowledgment,

        /// <summary>
        /// O57 - OMQ- General Order Message with Document Payload.
        /// </summary>
        OmqGeneralOrderMessageWithDocument,

        /// <summary>
        /// O58 - ORX - General Order Message with Document Payload Acknowledgement Message.
        /// </summary>
        OrxGeneralOrderMessageWithDocumentAcknowledgement,

        /// <summary>
        /// O59 - OML - Laboratory order for additional work up.
        /// </summary>
        OmlLabOrderForAdditionalWorkUp,
        ...
        /// <summary>
        /// Q33 - QBP - Get Donor Record Candidates.
        /// </summary>
        QbpGetDonorRecordCandidates,

        /// <summary>
        /// Q34 - QBP - Get Donor Record.
        /// </summary>
        QbpGetDonorRecord,
        ...
        /// <summary>
        /// R41 - Observation Report Alert Acknowledgement.
        /// </summary>
        ObservationReportAlertAcknowledgement,

        /// <summary>
        /// R42 - ORU â€“ Unsolicited Device Event Observation Message.
        /// </summary>
        OruUnsolicitedDeviceEventObservation,

        /// <summary>
        /// R43 - ORU â€“ Unsolicited Patient-Device Association Observation Message.
        /// </summary>
        OruUnsolicitedPatientDeviceAssociationObservation,
        ...
        /// <summary>
        /// U14 - INR/ACK - Automated Equipment Inventory Request.
        /// </summary>
