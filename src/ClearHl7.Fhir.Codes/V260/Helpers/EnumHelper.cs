...
namespace ClearHl7.Fhir.Codes.V260.Helpers
{
    ...
    public class EnumHelper : IEnumHelper
    {
        ...
        public string EnumToCode(CodeEmploymentStatus input)
        {
            return input switch
            {
                CodeEmploymentStatus.SeeChapter6 => "...",
        ...
        public string EnumToCode(CodeSegmentGroup input)
        {
            return input switch
            {
                ...
                CodeSegmentGroup.EncodedOrderDeprecated => "ENCODED ORDER",
                ...
                CodeSegmentGroup.FinancialCommonOrderDeprecated => "FINANCIAL_COMMON ORDER",
                ...
                CodeSegmentGroup.FinancialTimingQuantityDeprecated => "FINANCIAL_TIMING QUANTITY",
                CodeSegmentGroup.FinancialTimingQuantity => "FINANCIAL_TIMING_QUANTITY",
                CodeSegmentGroup.GeneralResourceDeprecated => "GENERAL RESOURCE",
                ...
                CodeSegmentGroup.LocationResourceDeprecated => "LOCATION RESOURCE",
                ...
                CodeSegmentGroup.PatientVisitDeprecated => "PATIENT VISIT",
                ...
                CodeSegmentGroup.PersonnelResourceDeprecated => "PERSONNEL RESOURCE",
        ...
        /// <param name="input">An enum value to convert.</param>
        /// <returns>A string.</returns>
        public string EnumToCode(CodeSequenceCondition input)
        {
            return input switch
            {
        ...
        public string EnumToCode(CodeSpecimenType input)
        {
            return input switch
            {
                CodeSpecimenType.NoSuggestedValues => "...",
