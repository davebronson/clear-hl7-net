...
namespace ClearHl7.V230.Segments
{
    ...
    public class CtiSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            SponsorStudyId = segments.Length > 1 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(1), false) : null;
            StudyPhaseIdentifier = segments.Length > 2 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(2), false) : null;
            StudyScheduledTimePoint = segments.Length > 3 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(3), false) : null;
        }
