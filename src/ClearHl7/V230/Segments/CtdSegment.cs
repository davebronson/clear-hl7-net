...
namespace ClearHl7.V230.Segments
{
    ...
    public class CtdSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ContactAddress = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[3], false, seps) : null;
            ContactLocation = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[4], false, seps) : null;
