...
namespace ClearHl7.V230.Segments
{
    ...
    public class CtdSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ContactAddress = segments.Length > 3 ? TypeHelper.Deserialize<ExtendedAddress>(segments.ElementAtOrDefault(3), false) : null;
            ContactLocation = segments.Length > 4 ? TypeHelper.Deserialize<EntityIdentifier>(segments.ElementAtOrDefault(4), false) : null;
            ...
            ContactIdentifiers = segments.Length > 7 ? segments.ElementAtOrDefault(7).Split(separator) : null;
        }
