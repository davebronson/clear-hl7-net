...
namespace ClearHl7.V230.Segments
{
    ...
    public class Ft1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            PerformedByCode = segments.Length > 20 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(20), false) : null;
            OrderedByCode = segments.Length > 21 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(21), false) : null;
            ...
            EnteredByCode = segments.Length > 24 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(24), false) : null;
