...
namespace ClearHl7.V230.Segments
{
    ...
    public class Gt1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            Citizenship = segments.Length > 35 && segments[35].Length > 0 ? segments[35].Split(seps.FieldRepeatSeparator, StringSplitOptions.None) : null;
            ...
            Religion = segments.Length > 41 && segments[41].Length > 0 ? segments[41] : null;
            MothersMaidenName = segments.Length > 42 && segments[42].Length > 0 ? TypeHelper.Deserialize<ExtendedPersonName>(segments[42], false, seps) : null;
            Nationality = segments.Length > 43 && segments[43].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[43], false, seps) : null;
            EthnicGroup = segments.Length > 44 && segments[44].Length > 0 ? segments[44] : null;
            ...
            GuarantorRace = segments.Length > 55 && segments[55].Length > 0 ? segments[55] : null;
        }
