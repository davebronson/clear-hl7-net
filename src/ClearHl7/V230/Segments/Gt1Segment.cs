...
namespace ClearHl7.V230.Segments
{
    ...
    public class Gt1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            Citizenship = segments.Length > 35 ? segments.ElementAtOrDefault(35).Split(separator) : null;
            ...
            Religion = segments.ElementAtOrDefault(41);
            MothersMaidenName = segments.Length > 42 ? TypeHelper.Deserialize<ExtendedPersonName>(segments.ElementAtOrDefault(42), false) : null;
            Nationality = segments.Length > 43 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(43), false) : null;
            EthnicGroup = segments.ElementAtOrDefault(44);
            ...
            GuarantorRace = segments.ElementAtOrDefault(55);
        }
