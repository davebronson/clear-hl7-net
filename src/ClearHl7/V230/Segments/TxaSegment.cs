...
namespace ClearHl7.V230.Segments
{
    ...
    public class TxaSegment : ISegment
    {
        ...
        /// <summary>
        /// TXA.2 - Document Type.
        /// <para>Suggested: 0270 Document Type -&gt; ClearHl7.Codes.V230.CodeDocumentType</para>
        /// </summary>
        ...
        /// </summary>
        public ExtendedCompositeIdNumberAndNameForPersons PrimaryActivityProviderCodeName { get; set; }
        ...
        /// </summary>
        public ExtendedCompositeIdNumberAndNameForPersons OriginatorCodeName { get; set; }
        ...
        /// </summary>
        public ExtendedCompositeIdNumberAndNameForPersons TranscriptionistCodeName { get; set; }
        ...
        /// <para>Suggested: 0271 Document Completion Status -&gt; ClearHl7.Codes.V230.CodeDocumentCompletionStatus</para>
        /// </summary>
        public string DocumentCompletionStatus { get; set; }

        /// <summary>
        /// TXA.18 - Document Confidentiality Status.
        /// <para>Suggested: 0272 Document Confidentiality Status</para>
        /// </summary>
        public string DocumentConfidentialityStatus { get; set; }

        /// <summary>
        /// TXA.19 - Document Availability Status.
        /// <para>Suggested: 0273 Document Availability Status -&gt; ClearHl7.Codes.V230.CodeDocumentAvailabilityStatus</para>
        /// </summary>
        public string DocumentAvailabilityStatus { get; set; }

        /// <summary>
        /// TXA.20 - Document Storage Status.
        /// <para>Suggested: 0275 Document Storage Status -&gt; ClearHl7.Codes.V230.CodeDocumentStorageStatus</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            PrimaryActivityProviderCodeName = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[5], false, seps) : null;
            ...
            OriginatorCodeName = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[9], false, seps) : null;
            ...
            TranscriptionistCodeName = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[11], false, seps) : null;
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                ...
                                PrimaryActivityProviderCodeName?.ToDelimitedString(),
                                ...
                                OriginatorCodeName?.ToDelimitedString(),
                                ...
                                TranscriptionistCodeName?.ToDelimitedString(),
