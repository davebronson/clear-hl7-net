...
namespace ClearHl7.V230.Segments
{
    ...
    public class TxaSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            PrimaryActivityProviderCodeName = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[5], false) : null;
            ...
            OriginatorCodeName = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[9], false) : null;
            ...
            TranscriptionistCodeName = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[11], false) : null;
