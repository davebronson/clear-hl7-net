...
namespace ClearHl7.V230.Segments
{
    ...
    public class PidSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            PatientId = segments.Length > 2 && segments[2].Length > 0 ? TypeSerializer.Deserialize<CompositeIdWithCheckDigit>(segments[2], false, seps) : null;
            ...
            PatientName = segments.Length > 5 && segments[5].Length > 0 ? TypeSerializer.Deserialize<ExtendedPersonName>(segments[5], false, seps) : null;
            MothersMaidenName = segments.Length > 6 && segments[6].Length > 0 ? TypeSerializer.Deserialize<ExtendedPersonName>(segments[6], false, seps) : null;
