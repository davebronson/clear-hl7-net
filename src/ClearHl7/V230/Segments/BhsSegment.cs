...
namespace ClearHl7.V230.Segments
{
    ...
    public class BhsSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            BatchSendingApplication = segments.Length > 3 && segments[3].Length > 0 ? segments[3] : null;
            BatchSendingFacility = segments.Length > 4 && segments[4].Length > 0 ? segments[4] : null;
            BatchReceivingApplication = segments.Length > 5 && segments[5].Length > 0 ? segments[5] : null;
            BatchReceivingFacility = segments.Length > 6 && segments[6].Length > 0 ? segments[6] : null;
