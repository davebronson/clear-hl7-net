...
namespace ClearHl7.V230.Segments
{
    ...
    public class In2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            AmbulatoryStatus = segments.ElementAtOrDefault(32);
            Citizenship = segments.ElementAtOrDefault(33);
            ...
            Religion = segments.ElementAtOrDefault(39);
            MothersMaidenName = segments.Length > 40 ? TypeHelper.Deserialize<ExtendedPersonName>(segments.ElementAtOrDefault(40), false) : null;
            Nationality = segments.Length > 41 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(41), false) : null;
            EthnicGroup = segments.ElementAtOrDefault(42);
            MaritalStatus = segments.Length > 43 ? segments.ElementAtOrDefault(43).Split(separator) : null;
            ...
            InsuranceCoContactPhoneNumber = segments.Length > 58 ? TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(segments.ElementAtOrDefault(58), false) : null;
            ...
            GuarantorsRelationshipToInsured = segments.ElementAtOrDefault(62);
            ...
            Race = segments.ElementAtOrDefault(71);
