...
namespace ClearHl7.V230.Segments
{
    ...
    public class In2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            MothersMaidenName = segments.Length > 40 && segments[40].Length > 0 ? TypeSerializer.Deserialize<ExtendedPersonName>(segments[40], false, seps) : null;
            ...
            InsuranceCoContactPhoneNumber = segments.Length > 58 && segments[58].Length > 0 ? TypeSerializer.Deserialize<ExtendedTelecommunicationNumber>(segments[58], false, seps) : null;
