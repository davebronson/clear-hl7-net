...
namespace ClearHl7.V230.Segments
{
    ...
    public class StfSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            StaffIdentifierList = segments.Length > 2 ? segments.ElementAtOrDefault(2).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            StaffName = segments.Length > 3 ? TypeHelper.Deserialize<ExtendedPersonName>(segments.ElementAtOrDefault(3), false) : null;
            ...
            PreferredMethodOfContact = segments.ElementAtOrDefault(16);
            MaritalStatus = segments.ElementAtOrDefault(17);
