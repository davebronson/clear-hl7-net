...
namespace ClearHl7.V230.Segments
{
    ...
    public class LocSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            OrganizationNameLoc = segments.Length > 4 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments.ElementAtOrDefault(4), false) : null;
            LocationAddress = segments.Length > 5 ? TypeHelper.Deserialize<ExtendedAddress>(segments.ElementAtOrDefault(5), false) : null;
