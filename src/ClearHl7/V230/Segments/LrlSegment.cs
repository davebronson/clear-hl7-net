...
namespace ClearHl7.V230.Segments
{
    ...
    public class LrlSegment : ISegment
    {
        ...
        /// </summary>
        public ExtendedCompositeNameAndIdNumberForOrganizations OrganizationalLocationRelationshipValue { get; set; }
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            LocationRelationshipId = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[4], false, seps) : null;
            OrganizationalLocationRelationshipValue = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments[5], false, seps) : null;
