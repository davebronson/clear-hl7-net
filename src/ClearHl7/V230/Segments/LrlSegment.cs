...
namespace ClearHl7.V230.Segments
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LrlSegment"/> class.
        /// </summary>
        public LrlSegment()
        {
        ...
        public LrlSegment(int ordinal)
        {
            Ordinal = ordinal;
        }

        /// <inheritdoc/>
        public string Id => "LRL";
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            OrganizationalLocationRelationshipValue = segments.Length > 5 && segments[5].Length > 0 ? TypeSerializer.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments[5], false, seps) : null;
