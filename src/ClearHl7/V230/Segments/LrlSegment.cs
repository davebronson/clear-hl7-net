...
namespace ClearHl7.V230.Segments
{
    ...
    public class LrlSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            LocationRelationshipId = segments.Length > 4 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(4), false) : null;
            OrganizationalLocationRelationshipValue = segments.Length > 5 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments.ElementAtOrDefault(5), false) : null;
