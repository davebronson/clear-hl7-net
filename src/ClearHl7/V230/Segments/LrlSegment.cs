...
namespace ClearHl7.V230.Segments
{
    ...
    public class LrlSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            OrganizationalLocationRelationshipValue = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments[5], false) : null;
