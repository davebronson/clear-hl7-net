...
namespace ClearHl7.V230.Segments
{
    ...
    public class Om2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ReferenceNormalRangeForOrdinalAndContinuousObservations = segments.Length > 6 ? TypeHelper.Deserialize<ReferenceRange>(segments.ElementAtOrDefault(6), false) : null;
            CriticalRangeForOrdinalAndContinuousObservations = segments.Length > 7 ? TypeHelper.Deserialize<NumericRange>(segments.ElementAtOrDefault(7), false) : null;
