...
namespace ClearHl7.V230.Segments
{
    ...
    public class Om2Segment : ISegment
    {
        ...
        /// </summary>
        public ReferenceRange ReferenceNormalRangeForOrdinalAndContinuousObservations { get; set; }

        /// <summary>
        /// OM2.7 - Critical Range for Ordinal and Continuous Observations.
        /// </summary>
        public NumericRange CriticalRangeForOrdinalAndContinuousObservations { get; set; }
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ReferenceNormalRangeForOrdinalAndContinuousObservations = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<ReferenceRange>(segments[6], false, seps) : null;
            CriticalRangeForOrdinalAndContinuousObservations = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<NumericRange>(segments[7], false, seps) : null;
