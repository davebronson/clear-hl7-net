...
namespace ClearHl7.V230.Segments
{
    ...
    public class Om2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ReferenceNormalRangeForOrdinalAndContinuousObservations = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<ReferenceRange>(segments[6], false) : null;
            CriticalRangeForOrdinalAndContinuousObservations = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<NumericRange>(segments[7], false) : null;
