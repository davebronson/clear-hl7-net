...
namespace ClearHl7.V230.Segments
{
    ...
    public class FacSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            FacilityAddress = segments.Length > 3 && segments[3].Length > 0 ? TypeSerializer.Deserialize<ExtendedAddress>(segments[3], false, seps) : null;
            ...
            SignatureAuthority = segments.Length > 9 && segments[9].Length > 0 ? TypeSerializer.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[9], false, seps) : null;
            SignatureAuthorityTitle = segments.Length > 10 && segments[10].Length > 0 ? segments[10] : null;
            SignatureAuthorityAddress = segments.Length > 11 && segments[11].Length > 0 ? TypeSerializer.Deserialize<ExtendedAddress>(segments[11], false, seps) : null;
