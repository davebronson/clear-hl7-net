...
namespace ClearHl7.V230.Segments
{
    ...
    public class FacSegment : ISegment
    {
        ...
        /// <summary>
        /// FAC.2 - Facility Type.
        /// <para>Suggested: 0331 Facility Type -&gt; ClearHl7.Codes.V230.CodeFacilityType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            FacilityAddress = segments.Length > 3 ? TypeHelper.Deserialize<ExtendedAddress>(segments.ElementAtOrDefault(3), false) : null;
            ...
            SignatureAuthority = segments.Length > 9 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(9), false) : null;
            SignatureAuthorityTitle = segments.ElementAtOrDefault(10);
            SignatureAuthorityAddress = segments.Length > 11 ? TypeHelper.Deserialize<ExtendedAddress>(segments.ElementAtOrDefault(11), false) : null;
