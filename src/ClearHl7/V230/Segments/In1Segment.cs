...
namespace ClearHl7.V230.Segments
{
    ...
    public class In1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            InsuredsRelationshipToPatient = segments.ElementAtOrDefault(17);
            ...
            VerificationBy = segments.Length > 30 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(30), false) : null;
