...
namespace ClearHl7.V230.Segments
{
    ...
    public class PrcSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            MinimumPrice = segments.Length > 9 ? TypeHelper.Deserialize<CompositePrice>(segments.ElementAtOrDefault(9), false) : null;
            MaximumPrice = segments.Length > 10 ? TypeHelper.Deserialize<CompositePrice>(segments.ElementAtOrDefault(10), false) : null;
            ...
            Cost = segments.Length > 17 ? TypeHelper.Deserialize<CompositePrice>(segments.ElementAtOrDefault(17), false) : null;
