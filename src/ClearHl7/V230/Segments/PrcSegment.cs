...
namespace ClearHl7.V230.Segments
{
    ...
    public class PrcSegment : ISegment
    {
        ...
        /// PRC.9 - Minimum Price.
        /// </summary>
        public CompositePrice MinimumPrice { get; set; }

        /// <summary>
        /// PRC.10 - Maximum Price.
        /// </summary>
        public CompositePrice MaximumPrice { get; set; }
        ...
        /// PRC.17 - Cost.
        /// </summary>
        public CompositePrice Cost { get; set; }

        /// <summary>
        /// PRC.18 - Charge on Indicator.
        /// <para>Suggested: 0269 Charge On Indicator -&gt; ClearHl7.Codes.V230.CodeChargeOnIndicator</para>
        /// </summary>
        ...
        internal void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            FacilityIdPrc = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            Department = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            MinimumPrice = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CompositePrice>(segments[9], false) : null;
            MaximumPrice = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CompositePrice>(segments[10], false) : null;
            ...
            BillingCategory = segments.Length > 14 && segments[14].Length > 0 ? segments[14].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            Cost = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<CompositePrice>(segments[17], false) : null;
