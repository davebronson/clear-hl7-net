...
namespace ClearHl7.V230.Segments
{
    ...
    public class PeoSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            CauseOfDeath = segments.Length > 18 ? segments.ElementAtOrDefault(18).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            PrimaryObserverName = segments.Length > 19 ? TypeHelper.Deserialize<ExtendedPersonName>(segments.ElementAtOrDefault(19), false) : null;
