...
namespace ClearHl7.V230.Segments
{
    ...
    public class Nk1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            MaritalStatus = segments.Length > 14 && segments[14].Length > 0 ? segments[14] : null;
            ...
            Citizenship = segments.Length > 19 && segments[19].Length > 0 ? segments[19].Split(seps.FieldRepeatSeparator, StringSplitOptions.None) : null;
            ...
            Religion = segments.Length > 25 && segments[25].Length > 0 ? segments[25] : null;
            MothersMaidenName = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<ExtendedPersonName>(segments[26], false, seps) : null;
            Nationality = segments.Length > 27 && segments[27].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[27], false, seps) : null;
            EthnicGroup = segments.Length > 28 && segments[28].Length > 0 ? segments[28] : null;
            ...
            Race = segments.Length > 35 && segments[35].Length > 0 ? segments[35] : null;
