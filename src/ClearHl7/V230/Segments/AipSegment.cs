...
namespace ClearHl7.V230.Segments
{
    ...
    public class AipSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            PersonnelResourceId = segments.Length > 3 && segments[3].Length > 0 ? TypeSerializer.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[3], false, seps) : null;
