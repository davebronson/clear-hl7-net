...
namespace ClearHl7.V230.Segments
{
    ...
    public class Pv1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            OtherHealthcareProvider = segments.Length > 52 && segments[52].Length > 0 ? segments[52].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
        }
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                ...
                                DischargeDateTime?.ToHl7DateTimeString(typeof(Pv1Segment), nameof(DischargeDateTime), Consts.DateTimeFormatPrecisionSecond, culture),
