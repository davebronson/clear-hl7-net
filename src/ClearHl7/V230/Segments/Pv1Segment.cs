...
namespace ClearHl7.V230.Segments
{
    ...
    public class Pv1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            AlternateVisitId = segments.Length > 50 && segments[50].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(segments[50], false, seps) : null;
            VisitIndicator = segments.Length > 51 && segments[51].Length > 0 ? segments[51] : null;
            OtherHealthcareProvider = segments.Length > 52 && segments[52].Length > 0 ? segments[52].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
        }
