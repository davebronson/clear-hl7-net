...
namespace ClearHl7.V230.Segments
{
    ...
    public class ArqSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            PlacerContactPerson = segments.Length > 15 && segments[15].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[15], false, seps) : null;
            ...
            PlacerContactAddress = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[17], false, seps) : null;
            ...
            EnteredByPerson = segments.Length > 19 && segments[19].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[19], false, seps) : null;
