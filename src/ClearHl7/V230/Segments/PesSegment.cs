...
namespace ClearHl7.V230.Segments
{
    ...
    public class PesSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            SenderOrganizationName = segments.Length > 1 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments.ElementAtOrDefault(1), false) : null;
