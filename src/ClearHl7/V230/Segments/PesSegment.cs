...
namespace ClearHl7.V230.Segments
{
    ...
    public class PesSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            SenderOrganizationName = segments.Length > 1 && segments[1].Length > 0 ? TypeSerializer.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments[1], false, seps) : null;
