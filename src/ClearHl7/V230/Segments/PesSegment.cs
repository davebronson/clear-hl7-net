...
namespace ClearHl7.V230.Segments
{
    ...
    public class PesSegment : ISegment
    {
        ...
        /// <para>Suggested: 0234 Report Timing -&gt; ClearHl7.Codes.V230.CodeReportTiming</para>
        /// </summary>
        public IEnumerable<string> EventReportTimingType { get; set; }

        /// <summary>
        /// PES.12 - Event Report Source.
        /// <para>Suggested: 0235 Report Source -&gt; ClearHl7.Codes.V230.CodeReportSource</para>
        /// </summary>
        public string EventReportSource { get; set; }

        /// <summary>
        /// PES.13 - Event Reported To.
        /// <para>Suggested: 0236 Event Reported To -&gt; ClearHl7.Codes.V230.CodeEventReportedTo</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            SenderOrganizationName = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments[1], false) : null;
