...
namespace ClearHl7.V230.Segments
{
    ...
    public class CsrSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            PersonPerformingStudyRegistration = segments.Length > 7 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(7), false) : null;
            StudyAuthorizingProvider = segments.Length > 8 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(8), false) : null;
