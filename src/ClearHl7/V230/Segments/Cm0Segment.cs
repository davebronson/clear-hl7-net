...
namespace ClearHl7.V230.Segments
{
    ...
    public class Cm0Segment : ISegment
    {
        ...
        /// </summary>
        public IEnumerable<CodedElement> AlternateStudyId { get; set; }
        ...
        /// </summary>
        public ExtendedCompositeIdNumberAndNameForPersons ChairmanOfStudy { get; set; }
        ...
        /// </summary>
        public ExtendedCompositeIdNumberAndNameForPersons ContactForStudy { get; set; }
        ...
        /// </summary>
        public ExtendedAddress ContactsAddress { get; set; }
        ...
        internal void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            SponsorStudyId = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[2], false) : null;
            AlternateStudyId = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            TitleOfStudy = segments.Length > 4 && segments[4].Length > 0 ? segments[4] : null;
            ChairmanOfStudy = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[5], false) : null;
            ...
            ContactForStudy = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[9], false) : null;
            ContactsTelephoneNumber = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(segments[10], false) : null;
            ContactsAddress = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[11], false) : null;
        }
