...
namespace ClearHl7.V230.Segments
{
    ...
    public class SchSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            EventReason = segments.Length > 6 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(6), false) : null;
            ...
            AppointmentTimingQuantity = segments.Length > 11 ? segments.ElementAtOrDefault(11).Split(separator).Select(x => TypeHelper.Deserialize<TimingQuantity>(x, false)) : null;
            PlacerContactPerson = segments.Length > 12 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(12), false) : null;
            ...
            PlacerContactAddress = segments.Length > 14 ? TypeHelper.Deserialize<ExtendedAddress>(segments.ElementAtOrDefault(14), false) : null;
            PlacerContactLocation = segments.Length > 15 ? TypeHelper.Deserialize<PersonLocation>(segments.ElementAtOrDefault(15), false) : null;
            FillerContactPerson = segments.Length > 16 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(16), false) : null;
            ...
            FillerContactAddress = segments.Length > 18 ? TypeHelper.Deserialize<ExtendedAddress>(segments.ElementAtOrDefault(18), false) : null;
            FillerContactLocation = segments.Length > 19 ? TypeHelper.Deserialize<PersonLocation>(segments.ElementAtOrDefault(19), false) : null;
            EnteredByPerson = segments.Length > 20 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments.ElementAtOrDefault(20), false) : null;
