...
namespace ClearHl7.V230.Segments
{
    ...
    public class SchSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            EventReason = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[6], false, seps) : null;
            ...
            AppointmentTimingQuantity = segments.Length > 11 && segments[11].Length > 0 ? segments[11].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<TimingQuantity>(x, false, seps)) : null;
            PlacerContactPerson = segments.Length > 12 && segments[12].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[12], false, seps) : null;
            ...
            PlacerContactAddress = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[14], false, seps) : null;
            ...
            FillerContactPerson = segments.Length > 16 && segments[16].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[16], false, seps) : null;
            ...
            FillerContactAddress = segments.Length > 18 && segments[18].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[18], false, seps) : null;
            ...
            EnteredByPerson = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[20], false, seps) : null;
            ...
            FillerStatusCode = segments.Length > 25 && segments[25].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[25], false, seps) : null;
        }
