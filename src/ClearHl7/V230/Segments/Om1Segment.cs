...
namespace ClearHl7.V230.Segments
{
    ...
    public class Om1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ObservationDescription = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[6], false, seps) : null;
            ...
            CodedRepresentationOfMethod = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[14], false, seps) : null;
            ...
            AddressOfOutsideSites = segments.Length > 28 && segments[28].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[28], false, seps) : null;
