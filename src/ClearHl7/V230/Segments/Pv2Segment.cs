...
namespace ClearHl7.V230.Segments
{
    ...
    public class Pv2Segment : ISegment
    {
        ...
        /// </summary>
        public ExtendedCompositeIdNumberAndNameForPersons ReferralSourceCode { get; set; }
        ...
        /// <para>Suggested: 0213 Purge Status Code -&gt; ClearHl7.Codes.V230.CodePurgeStatusCode</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ReferralSourceCode = segments.Length > 13 && segments[13].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[13], false, seps) : null;
            ...
            PatientChargeAdjustmentCode = segments.Length > 30 && segments[30].Length > 0 ? segments[30] : null;
