...
namespace ClearHl7.V230.Types
{
    ...
    public class NameWithDateAndLocation : IType
    {
        ...
        public NameWithDateAndLocation(CompositeIdNumberAndName name)
        {
            Name = name;
        }
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            Name = segments.Length > 0 && segments[0].Length > 0 ? TypeSerializer.Deserialize<CompositeIdNumberAndName>(segments[0], true, seps) : null;
