...
namespace ClearHl7.V231.Types
{
    ...
    public class ExtendedCompositeIdNumberAndNameForPersons : IType
    {
        ...
        public ExtendedCompositeIdNumberAndNameForPersons(string personIdentifier, string familyName, string givenName)
        {
            PersonIdentifier = personIdentifier;
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                culture,
                                StringHelper.StringFormatSequence(0, 15, IsSubcomponent ? Configuration.SubcomponentSeparator : Configuration.ComponentSeparator),
                                PersonIdentifier,
                                FamilyName,
                                GivenName,
