...
namespace ClearHl7.V231.Types
{
    ...
    public class PractitionerInstitutionalPrivileges : IType
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            Privilege = segments.Length > 0 && segments[0].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[0], true) : null;
            PrivilegeClass = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[1], true) : null;
