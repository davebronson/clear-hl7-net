...
namespace ClearHl7.V231.Types
{
    ...
    public class PractitionerInstitutionalPrivileges : IType
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            Privilege = segments.Length > 0 && segments[0].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[0], true, seps) : null;
            PrivilegeClass = segments.Length > 1 && segments[1].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[1], true, seps) : null;
