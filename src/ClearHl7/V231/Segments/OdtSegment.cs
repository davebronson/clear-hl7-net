...
namespace ClearHl7.V231.Segments
{
    ...
    public class OdtSegment : ISegment
    {
        ...
        /// <summary>
        /// ODT.1 - Tray Type.
        /// <para>Suggested: 0160 Tray Type -&gt; ClearHl7.Codes.V231.CodeTrayType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            TrayType = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[1], false, seps) : null;
