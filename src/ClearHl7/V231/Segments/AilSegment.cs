...
namespace ClearHl7.V231.Segments
{
    ...
    public class AilSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            LocationResourceId = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<PersonLocation>(segments[3], false, seps) : null;
            LocationTypeAil = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[4], false, seps) : null;
            LocationGroup = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[5], false, seps) : null;
