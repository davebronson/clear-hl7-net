...
namespace ClearHl7.V231.Segments
{
    ...
    public class PdcSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            Country = segments.Length > 2 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(2), false) : null;
            BrandName = segments.ElementAtOrDefault(3);
            DeviceFamilyName = segments.ElementAtOrDefault(4);
            GenericName = segments.Length > 5 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(5), false) : null;
            ...
            ProductCode = segments.Length > 9 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(9), false) : null;
