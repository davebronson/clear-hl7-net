...
namespace ClearHl7.V231.Segments
{
    ...
    public class Om4Segment : ISegment
    {
        ...
        /// <para>Suggested: 0170 Derived Specimen -&gt; ClearHl7.Codes.V231.CodeDerivedSpecimen</para>
        /// </summary>
        ...
        /// <para>Suggested: 0027 Priority -&gt; ClearHl7.Codes.V231.CodePriority</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ContainerUnits = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[5], false) : null;
            Specimen = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[6], false) : null;
            Additive = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[7], false) : null;
