...
namespace ClearHl7.V231.Segments
{
    ...
    public class Om1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            IdentityOfInstrumentUsedToPerformThisStudy = segments.Length > 13 && segments[13].Length > 0 ? segments[13].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            CodedRepresentationOfMethod = segments.Length > 14 && segments[14].Length > 0 ? segments[14].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            PortableDeviceIndicator = segments.Length > 15 && segments[15].Length > 0 ? segments[15] : null;
            ObservationProducingDepartmentSection = segments.Length > 16 && segments[16].Length > 0 ? segments[16].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            OutsideSitesWhereObservationMayBePerformed = segments.Length > 27 && segments[27].Length > 0 ? segments[27].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            ReflexTestsObservations = segments.Length > 34 && segments[34].Length > 0 ? segments[34].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
