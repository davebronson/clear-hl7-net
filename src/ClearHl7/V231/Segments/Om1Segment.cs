...
namespace ClearHl7.V231.Segments
{
    ...
    public class Om1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            CodedRepresentationOfMethod = segments.Length > 14 ? segments.ElementAtOrDefault(14).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
