...
namespace ClearHl7.V282.Segments
{
    ...
    public class CssSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            StudyQualityControlCodes = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
        }
