...
namespace ClearHl7.V282.Segments
{
    ...
    public class SddSegment : ISegment
    {
        ...
        /// <para>Suggested: 0667 Device Data State -&gt; ClearHl7.Fhir.Codes.V282.CodeDeviceDataState</para>
        /// </summary>
        public CodedWithExceptions DeviceDataState { get; set; }

        /// <summary>
        /// SDD.5 - Load Status.
        /// <para>Suggested: 0669 Load Status -&gt; ClearHl7.Fhir.Codes.V282.CodeLoadStatus</para>
        /// </summary>
