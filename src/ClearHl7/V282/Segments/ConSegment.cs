...
namespace ClearHl7.V282.Segments
{
    ...
    public class ConSegment : ISegment
    {
        ...
        /// <summary>
        /// CON.2 - Consent Type.
        /// <para>Suggested: 0496 Consent Type -&gt; ClearHl7.Codes.V282.CodeConsentType</para>
        /// </summary>
        ...
        /// <summary>
        /// CON.10 - Consent Mode.
        /// <para>Suggested: 0497 Consent Mode -&gt; ClearHl7.Codes.V282.CodeConsentMode</para>
        /// </summary>
        public CodedWithNoExceptions ConsentMode { get; set; }

        /// <summary>
        /// CON.11 - Consent Status.
        /// <para>Suggested: 0498 Consent Status -&gt; ClearHl7.Codes.V282.CodeConsentStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0499 Consent Bypass Reason -&gt; ClearHl7.Codes.V282.CodeConsentBypassReason</para>
        /// </summary>
        public CodedWithExceptions ConsentBypassReason { get; set; }

        /// <summary>
        /// CON.21 - Consent Disclosure Level.
        /// <para>Suggested: 0500 Consent Disclosure Level -&gt; ClearHl7.Codes.V282.CodeConsentDisclosureLevel</para>
        /// </summary>
        public string ConsentDisclosureLevel { get; set; }

        /// <summary>
        /// CON.22 - Consent Non-disclosure Reason.
        /// <para>Suggested: 0501 Consent Non-Disclosure Reason -&gt; ClearHl7.Codes.V282.CodeConsentNonDisclosureReason</para>
        /// </summary>
        public CodedWithExceptions ConsentNonDisclosureReason { get; set; }

        /// <summary>
        /// CON.23 - Non-subject Consenter Reason.
        /// <para>Suggested: 0502 Non-Subject Consenter Reason -&gt; ClearHl7.Codes.V282.CodeNonSubjectConsenterReason</para>
        /// </summary>
        ...
        /// <para>Suggested: 0548 Signatory's Relationship To Subject -&gt; ClearHl7.Codes.V282.CodeSignatorysRelationshipToSubject</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ConsentType = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[2], false, seps) : null;
            ConsentFormIdAndVersion = segments.Length > 3 && segments[3].Length > 0 ? segments[3] : null;
            ConsentFormNumber = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[4], false, seps) : null;
            ...
            ConsentMode = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[10], false, seps) : null;
            ConsentStatus = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[11], false, seps) : null;
            ...
            LanguageTranslatedTo = segments.Length > 18 && segments[18].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[18], false, seps) : null;
            InformationalMaterialSuppliedIndicator = segments.Length > 19 && segments[19].Length > 0 ? segments[19] : null;
            ConsentBypassReason = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[20], false, seps) : null;
            ConsentDisclosureLevel = segments.Length > 21 && segments[21].Length > 0 ? segments[21] : null;
            ConsentNonDisclosureReason = segments.Length > 22 && segments[22].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[22], false, seps) : null;
            NonSubjectConsenterReason = segments.Length > 23 && segments[23].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[23], false, seps) : null;
            ConsenterId = segments.Length > 24 && segments[24].Length > 0 ? segments[24].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            RelationshipToSubject = segments.Length > 25 && segments[25].Length > 0 ? segments[25].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
        }
