...
namespace ClearHl7.V282.Segments
{
    ...
    public class Om1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            OtherServiceTestObservationIdsForTheObservation = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            NatureOfServiceTestObservation = segments.Length > 18 && segments[18].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[18], false, seps) : null;
            ...
            ObservationsRequiredToInterpretThisObservation = segments.Length > 31 && segments[31].Length > 0 ? segments[31].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            ContraindicationsToObservations = segments.Length > 33 && segments[33].Length > 0 ? segments[33].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            RulesThatTriggerReflexTesting = segments.Length > 35 && segments[35].Length > 0 ? segments[35].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<Text>(x, false, seps)) : null;
            FixedCannedMessage = segments.Length > 36 && segments[36].Length > 0 ? segments[36].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            PatientPreparation = segments.Length > 37 && segments[37].Length > 0 ? segments[37].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<Text>(x, false, seps)) : null;
            ...
            TaxonomicClassificationCode = segments.Length > 50 && segments[50].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[50], false, seps) : null;
            ...
            ReplacementProducersServiceTestObservationId = segments.Length > 52 && segments[52].Length > 0 ? segments[52].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            PriorResultsInstructions = segments.Length > 53 && segments[53].Length > 0 ? segments[53].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<Text>(x, false, seps)) : null;
            SpecialInstructions = segments.Length > 54 && segments[54].Length > 0 ? TypeHelper.Deserialize<Text>(segments[54], false, seps) : null;
            TestCategory = segments.Length > 55 && segments[55].Length > 0 ? segments[55].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ObservationIdAssociatedWithProducersServiceTestObservationId = segments.Length > 56 && segments[56].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[56], false, seps) : null;
            TypicalTurnAroundTimeWithUnits = segments.Length > 57 && segments[57].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[57], false, seps) : null;
            GenderRestriction = segments.Length > 58 && segments[58].Length > 0 ? segments[58].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            AgeRestriction = segments.Length > 59 && segments[59].Length > 0 ? segments[59].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<NumericRange>(x, false, seps)) : null;
        }
