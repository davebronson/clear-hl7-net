...
namespace ClearHl7.V282.Segments
{
    ...
    public class TxaSegment : ISegment
    {
        ...
        /// <summary>
        /// TXA.2 - Document Type.
        /// <para>Suggested: 0270 Document Type -&gt; ClearHl7.Codes.V282.CodeDocumentType</para>
        /// </summary>
        public CodedWithExceptions DocumentType { get; set; }

        /// <summary>
        /// TXA.3 - Document Content Presentation.
        /// <para>Suggested: 0191 Type Of Referenced Data -&gt; ClearHl7.Codes.V282.CodeTypeOfReferencedData</para>
        /// </summary>
        ...
        /// <para>Suggested: 0271 Document Completion Status -&gt; ClearHl7.Codes.V282.CodeDocumentCompletionStatus</para>
        /// </summary>
        public string DocumentCompletionStatus { get; set; }

        /// <summary>
        /// TXA.18 - Document Confidentiality Status.
        /// <para>Suggested: 0272 Document Confidentiality Status -&gt; ClearHl7.Codes.V282.CodeDocumentConfidentialityStatus</para>
        /// </summary>
        public string DocumentConfidentialityStatus { get; set; }

        /// <summary>
        /// TXA.19 - Document Availability Status.
        /// <para>Suggested: 0273 Document Availability Status -&gt; ClearHl7.Codes.V282.CodeDocumentAvailabilityStatus</para>
        /// </summary>
        public string DocumentAvailabilityStatus { get; set; }

        /// <summary>
        /// TXA.20 - Document Storage Status.
        /// <para>Suggested: 0275 Document Storage Status -&gt; ClearHl7.Codes.V282.CodeDocumentStorageStatus</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            DocumentType = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[2], false, seps) : null;
            ...
            PrimaryActivityProviderCodeName = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            ...
            OriginatorCodeName = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            AssignedDocumentAuthenticator = segments.Length > 10 && segments[10].Length > 0 ? segments[10].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            TranscriptionistCodeName = segments.Length > 11 && segments[11].Length > 0 ? segments[11].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            UniqueDocumentNumber = segments.Length > 12 && segments[12].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[12], false, seps) : null;
            ParentDocumentNumber = segments.Length > 13 && segments[13].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[13], false, seps) : null;
            PlacerOrderNumber = segments.Length > 14 && segments[14].Length > 0 ? segments[14].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<EntityIdentifier>(x, false, seps)) : null;
            FillerOrderNumber = segments.Length > 15 && segments[15].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[15], false, seps) : null;
            ...
            AuthenticationPersonTimeStampSet = segments.Length > 22 && segments[22].Length > 0 ? segments[22].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<PerformingPersonTimeStamp>(x, false, seps)) : null;
            DistributedCopiesCodeAndNameOfRecipients = segments.Length > 23 && segments[23].Length > 0 ? segments[23].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            FolderAssignment = segments.Length > 24 && segments[24].Length > 0 ? segments[24].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            DocumentTitle = segments.Length > 25 && segments[25].Length > 0 ? segments[25].Split(seps.FieldRepeatSeparator, StringSplitOptions.None) : null;
            AgreedDueDateTime = segments.Length > 26 && segments[26].Length > 0 ? segments[26].ToNullableDateTime() : null;
        }
