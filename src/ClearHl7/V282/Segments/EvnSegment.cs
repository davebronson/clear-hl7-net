...
namespace ClearHl7.V282.Segments
{
    ...
    public class EvnSegment : ISegment
    {
        ...
        /// <para>Suggested: 0062 Event Reason -&gt; ClearHl7.Codes.V282.CodeEventReason</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            EventReasonCode = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[4], false, seps) : null;
