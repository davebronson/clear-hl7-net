...
namespace ClearHl7.V282.Segments
{
    ...
    public class IsdSegment : ISegment
    {
        ...
        /// <para>Suggested: 0368 Remote Control Command -&gt; ClearHl7.Fhir.Codes.V282.CodeRemoteControlCommand</para>
        /// </summary>
        public CodedWithExceptions InteractionTypeIdentifier { get; set; }

        /// <summary>
        /// ISD.3 - Interaction Active State.
        /// <para>Suggested: 0387 Command Response -&gt; ClearHl7.Fhir.Codes.V282.CodeCommandResponse</para>
        /// </summary>
