...
namespace ClearHl7.V282.Types
{
    ...
    public class EncapsulatedData : IType
    {
        ...
        /// <summary>
        /// ED.2 - Type of Data.
        /// <para>Suggested: 0834 MIME Types -&gt; ClearHl7.Codes.V282.CodeMimeTypes</para>
        /// </summary>
        public string TypeOfData { get; set; }

        /// <summary>
        /// ED.3 - Data Subtype.
        /// <para>Suggested: 0291 Subtype Of Referenced Data -&gt; ClearHl7.Codes.V282.CodeSubtypeOfReferencedData</para>
        /// </summary>
        public string DataSubtype { get; set; }

        /// <summary>
        /// ED.4 - Encoding.
        /// <para>Suggested: 0299 Encoding -&gt; ClearHl7.Codes.V282.CodeEncoding</para>
        /// </summary>
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                culture,
                                StringHelper.StringFormatSequence(0, 5, IsSubcomponent ? Configuration.SubcomponentSeparator : Configuration.ComponentSeparator),
