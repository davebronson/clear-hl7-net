...
namespace ClearHl7.V240.Segments
{
    ...
    public class LocSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            LocationTypeLoc = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(separator) : null;
            ...
            LicenseNumber = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            LocationEquipment = segments.Length > 8 && segments[8].Length > 0 ? segments[8].Split(separator) : null;
