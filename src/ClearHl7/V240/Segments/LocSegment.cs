...
namespace ClearHl7.V240.Segments
{
    ...
    public class LocSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            LocationTypeLoc = segments.Length > 3 ? segments.ElementAtOrDefault(3).Split(separator) : null;
            ...
            LicenseNumber = segments.Length > 7 ? segments.ElementAtOrDefault(7).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            LocationEquipment = segments.Length > 8 ? segments.ElementAtOrDefault(8).Split(separator) : null;
            LocationServiceCode = segments.ElementAtOrDefault(9);
        }
