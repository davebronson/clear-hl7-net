...
namespace ClearHl7.V240.Segments
{
    ...
    public class MfaSegment : ISegment
    {
        ...
        /// <para>Suggested: 0180 Masterfile Action Code -&gt; ClearHl7.Codes.V240.CodeMasterfileActionCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0181 MFN Record-Level Error Return -&gt; ClearHl7.Codes.V240.CodeMfnRecordLevelErrorReturn</para>
        /// </summary>
        ...
        /// <para>Suggested: 0355 Primary Key Value Type -&gt; ClearHl7.Codes.V240.CodePrimaryKeyValueType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            MfnRecordLevelErrorReturn = segments.Length > 4 && segments[4].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[4], false, seps) : null;
            PrimaryKeyValueMfa = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
