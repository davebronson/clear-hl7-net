...
namespace ClearHl7.V240.Segments
{
    ...
    public class Ub1Segment : ISegment
    {
        ...
        /// <summary>
        /// UB1.16 - Occurrence.
        /// <para>Suggested: 0350 Occurrence Code</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            SpecialProgramIndicator = segments.Length > 12 && segments[12].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[12], false, seps) : null;
            PsroUrApprovalIndicator = segments.Length > 13 && segments[13].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[13], false, seps) : null;
            ...
            OccurrenceSpan = segments.Length > 17 && segments[17].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[17], false, seps) : null;
