...
namespace ClearHl7.V240.Segments
{
    ...
    public class In3Segment : ISegment
    {
        ...
        /// <summary>
        /// IN3.5 - Penalty.
        /// <para>Suggested: 0148 Money Or Percentage Indicator -&gt; ClearHl7.Codes.V240.CodeMoneyOrPercentageIndicator</para>
        /// </summary>
        ...
        /// <summary>
        /// IN3.11 - Days.
        /// <para>Suggested: 0149 Day Type -&gt; ClearHl7.Codes.V240.CodeDayType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            NonConcurCodeDescription = segments.Length > 12 && segments[12].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[12], false, seps) : null;
            ...
            AppealReason = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[17], false, seps) : null;
            CertificationAgency = segments.Length > 18 && segments[18].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[18], false, seps) : null;
            ...
            PreCertificationRequirement = segments.Length > 20 && segments[20].Length > 0 ? segments[20].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<PreCertificationRequired>(x, false, seps)) : null;
