...
namespace ClearHl7.V240.Segments
{
    ...
    public class ErqSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            InputParameterList = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(separator).Select(x => TypeHelper.Deserialize<QueryInputParameterList>(x, false)) : null;
        }
