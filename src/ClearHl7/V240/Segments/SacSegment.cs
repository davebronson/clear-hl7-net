...
namespace ClearHl7.V240.Segments
{
    ...
    public class SacSegment : ISegment
    {
        ...
        /// <para>Suggested: 0370 Container Status -&gt; ClearHl7.Codes.V240.CodeContainerStatus</para>
        /// </summary>
        ...
        /// <summary>
        /// SAC.30 - Treatment.
        /// <para>Suggested: 0373 Treatment -&gt; ClearHl7.Codes.V240.CodeTreatment</para>
        /// </summary>
        ...
        /// <para>Suggested: 0374 System Induced Contaminants -&gt; ClearHl7.Codes.V240.CodeSystemInducedContaminants</para>
        /// </summary>
        ...
        /// <para>Suggested: 0375 Artificial Blood -&gt; ClearHl7.Codes.V240.CodeArtificialBlood</para>
        /// </summary>
        public CodedElement ArtificialBlood { get; set; }

        /// <summary>
        /// SAC.43 - Special Handling Code.
        /// <para>Suggested: 0376 Special Handling Code -&gt; ClearHl7.Codes.V240.CodeSpecialHandlingCode</para>
        /// </summary>
        public IEnumerable<CodedElement> SpecialHandlingCode { get; set; }

        /// <summary>
        /// SAC.44 - Other Environmental Factors.
        /// <para>Suggested: 0377 Other Environmental Factors -&gt; ClearHl7.Codes.V240.CodeOtherEnvironmentalFactors</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            SpecimenSource = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<SpecimentSource>(segments[6], false, seps) : null;
            RegistrationDateTime = segments.Length > 7 && segments[7].Length > 0 ? segments[7].ToNullableDateTime() : null;
            ContainerStatus = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[8], false, seps) : null;
            CarrierType = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[9], false, seps) : null;
            ...
            TrayTypeSac = segments.Length > 12 && segments[12].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[12], false, seps) : null;
            ...
            Location = segments.Length > 15 && segments[15].Length > 0 ? segments[15].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            ContainerHeightDiameterDeltaUnits = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[20], false, seps) : null;
            ...
            VolumeUnits = segments.Length > 24 && segments[24].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[24], false, seps) : null;
            SeparatorType = segments.Length > 25 && segments[25].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[25], false, seps) : null;
            CapType = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[26], false, seps) : null;
            ...
            SpecimenComponent = segments.Length > 28 && segments[28].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[28], false, seps) : null;
            ...
            Treatment = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[30], false, seps) : null;
            ...
            HemolysisIndexUnits = segments.Length > 33 && segments[33].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[33], false, seps) : null;
            LipemiaIndex = segments.Length > 34 && segments[34].Length > 0 ? segments[34].ToNullableDecimal() : null;
            LipemiaIndexUnits = segments.Length > 35 && segments[35].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[35], false, seps) : null;
            IcterusIndex = segments.Length > 36 && segments[36].Length > 0 ? segments[36].ToNullableDecimal() : null;
            IcterusIndexUnits = segments.Length > 37 && segments[37].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[37], false, seps) : null;
            FibrinIndex = segments.Length > 38 && segments[38].Length > 0 ? segments[38].ToNullableDecimal() : null;
            FibrinIndexUnits = segments.Length > 39 && segments[39].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[39], false, seps) : null;
            SystemInducedContaminants = segments.Length > 40 && segments[40].Length > 0 ? segments[40].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            DrugInterference = segments.Length > 41 && segments[41].Length > 0 ? segments[41].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ArtificialBlood = segments.Length > 42 && segments[42].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[42], false, seps) : null;
            SpecialHandlingCode = segments.Length > 43 && segments[43].Length > 0 ? segments[43].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            OtherEnvironmentalFactors = segments.Length > 44 && segments[44].Length > 0 ? segments[44].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
        }
