...
namespace ClearHl7.V240.Segments
{
    ...
    public class Om2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            CriticalRangeForOrdinalAndContinuousObservations = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<NumericRange>(x, false)) : null;
