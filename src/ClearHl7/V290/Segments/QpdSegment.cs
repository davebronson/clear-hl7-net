...
namespace ClearHl7.V290.Segments
{
    ...
    public class QpdSegment : ISegment
    {
        ...
        public QpdSegment FromDelimitedString(string delimitedString)
        {
            ...
            MessageQueryName = segments.Length > 1 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(1)) : null;
            QueryTag = segments.ElementAtOrDefault(2);
            UserParametersInSuccessiveFields = segments.ElementAtOrDefault(3);
