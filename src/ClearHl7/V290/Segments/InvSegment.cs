...
namespace ClearHl7.V290.Segments
{
    ...
    public class InvSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            EquipmentStateIndicatorTypeCode = segments.Length > 21 && segments[21].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[21], false, seps) : null;
            EquipmentStateIndicatorValue = segments.Length > 22 && segments[22].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[22], false, seps) : null;
        }
