...
namespace ClearHl7.V290.Segments
{
    ...
    public class DpsSegment : ISegment
    {
        ...
        public DpsSegment FromDelimitedString(string delimitedString)
        {
            ...
            DiagnosisCodeMcp = segments.Length > 1 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(1)) : null;
            ProcedureCode = segments.Length > 2 ? segments.ElementAtOrDefault(2).Split(separator).Select(x => new CodedWithExceptions().FromDelimitedString(x)) : null;
            ...
            TypeOfLimitation = segments.Length > 5 ? new CodedWithNoExceptions().FromDelimitedString(segments.ElementAtOrDefault(5)) : null;
