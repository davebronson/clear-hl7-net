...
namespace ClearHl7.V290.Segments
{
    ...
    public class BhsSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            SecurityHandlingInstructions = segments.Length > 16 && segments[16].Length > 0 ? segments[16].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            SpecialAccessRestrictionInstructions = segments.Length > 17 && segments[17].Length > 0 ? segments[17].Split(separator) : null;
        }
