...
namespace ClearHl7.V290.Segments
{
    ...
    public class ArqSegment : ISegment
    {
        ...
        /// <summary>
        /// ARQ.26 - Alternate Placer Order Group Number.
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            RequestEventReason = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[6], false, seps) : null;
            ...
            AlternatePlacerOrderGroupNumber = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<EntityIdentifierPair>(segments[26], false, seps) : null;
        }
