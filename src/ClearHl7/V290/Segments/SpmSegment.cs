...
namespace ClearHl7.V290.Segments
{
    ...
    public class SpmSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            CultureStartDateTime = segments.Length > 33 && segments[33].Length > 0 ? segments[33].ToNullableDateTime() : null;
            CultureFinalDateTime = segments.Length > 34 && segments[34].Length > 0 ? segments[34].ToNullableDateTime() : null;
