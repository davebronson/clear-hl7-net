...
namespace ClearHl7.V290.Segments
{
    ...
    public class SacSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ContainerLength = segments.Length > 45 && segments[45].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[45], false) : null;
            ContainerWidth = segments.Length > 46 && segments[46].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[46], false) : null;
            ContainerForm = segments.Length > 47 && segments[47].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[47], false) : null;
            ContainerMaterial = segments.Length > 48 && segments[48].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[48], false) : null;
            ContainerCommonName = segments.Length > 49 && segments[49].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[49], false) : null;
        }
