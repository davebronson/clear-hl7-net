...
namespace ClearHl7.V290.Segments
{
    ...
    public class ItmSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ItemNaturalAccountCode = segments.Length > 19 && segments[19].Length > 0 ? TypeSerializer.Deserialize<CodedWithExceptions>(segments[19], false, seps) : null;
            ...
            HazardousIndicator = segments.Length > 30 && segments[30].Length > 0 ? TypeSerializer.Deserialize<CodedWithNoExceptions>(segments[30], false, seps) : null;
            SterileIndicator = segments.Length > 31 && segments[31].Length > 0 ? TypeSerializer.Deserialize<CodedWithNoExceptions>(segments[31], false, seps) : null;
            MaterialDataSafetySheetNumber = segments.Length > 32 && segments[32].Length > 0 ? TypeSerializer.Deserialize<EntityIdentifier>(segments[32], false, seps) : null;
            UnitedNationsStandardProductsAndServicesCode = segments.Length > 33 && segments[33].Length > 0 ? TypeSerializer.Deserialize<CodedWithExceptions>(segments[33], false, seps) : null;
            ContractDate = segments.Length > 34 && segments[34].Length > 0 ? TypeSerializer.Deserialize<DateTimeRange>(segments[34], false, seps) : null;
            ManufacturerContactName = segments.Length > 35 && segments[35].Length > 0 ? TypeSerializer.Deserialize<ExtendedPersonName>(segments[35], false, seps) : null;
            ManufacturerContactInformation = segments.Length > 36 && segments[36].Length > 0 ? TypeSerializer.Deserialize<ExtendedTelecommunicationNumber>(segments[36], false, seps) : null;
