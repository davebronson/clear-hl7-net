...
namespace ClearHl7.V290.Segments
{
    ...
    public class Pr1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            TreatingOrganizationalUnit = segments.Length > 23 && segments[23].Length > 0 ? segments[23].Split(separator).Select(x => TypeHelper.Deserialize<PersonLocation>(x, false)) : null;
