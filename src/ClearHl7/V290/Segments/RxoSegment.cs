...
namespace ClearHl7.V290.Segments
{
    ...
    public class RxoSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            OrderingProvidersDeaNumber = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[14], false, seps) : null;
