...
namespace ClearHl7.V290.Segments
{
    ...
    public class CspSegment : ISegment
    {
        ...
        public CspSegment FromDelimitedString(string delimitedString)
        {
            ...
            StudyPhaseIdentifier = segments.Length > 1 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(1)) : null;
            ...
            StudyPhaseEvaluability = segments.Length > 4 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(4)) : null;
