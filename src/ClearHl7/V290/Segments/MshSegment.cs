...
namespace ClearHl7.V290.Segments
{
    ...
    public class MshSegment : ISegment, IMshSegment
    {
        ...
        /// <summary>
        /// MSH.12 - Version ID.  The default is &quot;2.9&quot;.
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ReceivingFacility = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<HierarchicDesignator>(x, false, seps)) : null;
            ...
            SecurityClassificationTag = segments.Length > 25 && segments[25].Length > 0 ? TypeSerializer.Deserialize<CodedWithExceptions>(segments[25], false, seps) : null;
            SecurityHandlingInstructions = segments.Length > 26 && segments[26].Length > 0 ? segments[26].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
