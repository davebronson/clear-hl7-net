...
namespace ClearHl7.V290.Segments
{
    ...
    public class MshSegment : ISegment
    {
        ...
        /// <para>Suggested: 0362 Facility</para>
        /// </summary>
        public IEnumerable<HierarchicDesignator> ReceivingFacility { get; set; }
        ...
        /// <para>Suggested: 0155 Accept/Application Acknowledgment Conditions -&gt; ClearHl7.Codes.V290.CodeAcceptApplicationAcknowledgmentConditions</para>
        /// </summary>
        ...
        /// <para>Suggested: 0211 Alternate Character Sets -&gt; ClearHl7.Codes.V290.CodeAlternateCharacterSets</para>
        /// </summary>
        ...
        /// <para>Suggested: 0356 Alternate Character Set Handling Scheme -&gt; ClearHl7.Codes.V290.CodeAlternateCharacterSetHandlingScheme</para>
        /// </summary>
        ...
        /// <summary>
        /// MSH.28 - Special Access Restriction Instructions.
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ReceivingFacility = segments.Length > 5 ? segments.ElementAtOrDefault(5).Split(separator).Select(x => TypeHelper.Deserialize<HierarchicDesignator>(x, false)) : null;
            ...
            PrincipalLanguageOfMessage = segments.Length > 18 ? TypeHelper.Deserialize<CodedWithExceptions>(segments.ElementAtOrDefault(18), false) : null;
            ...
            SendingResponsibleOrganization = segments.Length > 21 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments.ElementAtOrDefault(21), false) : null;
            ReceivingResponsibleOrganization = segments.Length > 22 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments.ElementAtOrDefault(22), false) : null;
            SendingNetworkAddress = segments.Length > 23 ? TypeHelper.Deserialize<HierarchicDesignator>(segments.ElementAtOrDefault(23), false) : null;
            ReceivingNetworkAddress = segments.Length > 24 ? TypeHelper.Deserialize<HierarchicDesignator>(segments.ElementAtOrDefault(24), false) : null;
            SecurityClassificationTag = segments.Length > 25 ? TypeHelper.Deserialize<CodedWithExceptions>(segments.ElementAtOrDefault(25), false) : null;
            SecurityHandlingInstructions = segments.Length > 26 ? segments.ElementAtOrDefault(26).Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            SpecialAccessRestrictionInstructions = segments.Length > 27 ? segments.ElementAtOrDefault(27).Split(separator) : null;
        }
