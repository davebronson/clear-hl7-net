...
namespace ClearHl7.V290.Segments
{
    ...
    public class ArvSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            SecurityHandlingInstructions = segments.Length > 8 && segments[8].Length > 0 ? segments[8].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            AccessRestrictionMessageLocation = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(separator).Select(x => TypeHelper.Deserialize<MessageLocation>(x, false)) : null;
