...
namespace ClearHl7.V290.Segments
{
    ...
    public class CtiSegment : ISegment
    {
        ...
        public CtiSegment FromDelimitedString(string delimitedString)
        {
            ...
            StudyScheduledTimePoint = segments.Length > 3 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(3)) : null;
            ActionCode = segments.ElementAtOrDefault(4);
