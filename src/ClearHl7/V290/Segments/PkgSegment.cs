...
namespace ClearHl7.V290.Segments
{
    ...
    public class PkgSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ContractPrice = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<Money>(segments[9], false) : null;
            QuantityOfEach = segments.Length > 10 && segments[10].Length > 0 ? segments[10].ToNullableDecimal() : null;
            VendorCatalogNumber = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[11], false) : null;
        }
