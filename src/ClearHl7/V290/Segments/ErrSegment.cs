...
namespace ClearHl7.V290.Segments
{
    ...
    public class ErrSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ErrorLocation = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<MessageLocation>(x, false, seps)) : null;
