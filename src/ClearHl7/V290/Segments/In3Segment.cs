...
namespace ClearHl7.V290.Segments
{
    ...
    public class In3Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            PreCertificationRequirement = segments.Length > 20 && segments[20].Length > 0 ? segments[20].Split(separator).Select(x => TypeHelper.Deserialize<InsuranceCertificationDefinition>(x, false)) : null;
            ...
            SecondOpinionDocumentationReceived = segments.Length > 24 && segments[24].Length > 0 ? segments[24].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            OnlineVerificationResult = segments.Length > 29 && segments[29].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[29], false) : null;
            OnlineVerificationResultErrorCode = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[30], false) : null;
