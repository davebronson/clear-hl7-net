...
namespace ClearHl7.V290.Segments
{
    ...
    public class In3Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            OnlineVerificationResult = segments.Length > 29 && segments[29].Length > 0 ? TypeSerializer.Deserialize<CodedWithExceptions>(segments[29], false, seps) : null;
            OnlineVerificationResultErrorCode = segments.Length > 30 && segments[30].Length > 0 ? TypeSerializer.Deserialize<CodedWithExceptions>(segments[30], false, seps) : null;
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                ...
                                OnlineVerificationDateTime?.ToHl7DateTimeString(typeof(In3Segment), nameof(OnlineVerificationDateTime), Consts.DateTimeFormatPrecisionSecond, culture),
