...
namespace ClearHl7.V290.Segments
{
    ...
    public class RelSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            SourceInformationInstanceObjectType = segments.Length > 17 && segments[17].Length > 0 ? segments[17] : null;
            TargetInformationInstanceObjectType = segments.Length > 18 && segments[18].Length > 0 ? segments[18] : null;
        }
