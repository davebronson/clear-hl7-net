...
namespace ClearHl7.V290.Segments
{
    ...
    public class OrcSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ParentOrder = segments.Length > 8 && segments[8].Length > 0 ? segments[8].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<EntityIdentifierPair>(x, false, seps)) : null;
            ...
            OrderStatusDateRange = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<DateTimeRange>(segments[36], false, seps) : null;
            OrderCreationDateTime = segments.Length > 37 && segments[37].Length > 0 ? segments[37].ToNullableDateTime() : null;
            FillerOrderGroupNumber = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[38], false, seps) : null;
        }
