...
namespace ClearHl7.V290.Segments
{
    ...
    public class StzSegment : ISegment
    {
        ...
        public StzSegment FromDelimitedString(string delimitedString)
        {
            ...
            SterilizationType = segments.Length > 1 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(1)) : null;
            SterilizationCycle = segments.Length > 2 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(2)) : null;
            MaintenanceCycle = segments.Length > 3 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(3)) : null;
            MaintenanceType = segments.Length > 4 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(4)) : null;
