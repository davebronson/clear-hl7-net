...
namespace ClearHl7.V290.Segments
{
    ...
    public class BtxSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            BpUniqueId = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[20], false, seps) : null;
            ActionCode = segments.Length > 21 && segments[21].Length > 0 ? segments[21] : null;
        }
