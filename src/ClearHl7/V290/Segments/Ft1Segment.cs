...
namespace ClearHl7.V290.Segments
{
    ...
    public class Ft1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            TransactionId = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(segments[2], false) : null;
            ...
            DmeCertificateOfMedicalNecessityTransmissionCode = segments.Length > 44 && segments[44].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[44], false) : null;
            DmeCertificationTypeCode = segments.Length > 45 && segments[45].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[45], false) : null;
            ...
            DmeRentalPrice = segments.Length > 51 && segments[51].Length > 0 ? TypeHelper.Deserialize<Money>(segments[51], false) : null;
            DmePurchasePrice = segments.Length > 52 && segments[52].Length > 0 ? TypeHelper.Deserialize<Money>(segments[52], false) : null;
            DmeFrequencyCode = segments.Length > 53 && segments[53].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[53], false) : null;
            DmeCertificationConditionIndicator = segments.Length > 54 && segments[54].Length > 0 ? segments[54] : null;
            DmeConditionIndicatorCode = segments.Length > 55 && segments[55].Length > 0 ? segments[55].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ServiceReasonCode = segments.Length > 56 && segments[56].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[56], false) : null;
        }
