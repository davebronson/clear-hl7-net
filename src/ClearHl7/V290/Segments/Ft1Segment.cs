...
namespace ClearHl7.V290.Segments
{
    ...
    public class Ft1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            DmeConditionIndicatorCode = segments.Length > 55 && segments[55].Length > 0 ? segments[55].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
