    ...
    public class Ft1Segment : ISegment
    {
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                ...
                                DmeCertificationRevisionDate?.ToHl7DateTimeString(typeof(Ft1Segment), nameof(DmeCertificationRevisionDate), Consts.DateFormatPrecisionDay, culture),
                                DmeInitialCertificationDate?.ToHl7DateTimeString(typeof(Ft1Segment), nameof(DmeInitialCertificationDate), Consts.DateFormatPrecisionDay, culture),
                                DmeLastCertificationDate?.ToHl7DateTimeString(typeof(Ft1Segment), nameof(DmeLastCertificationDate), Consts.DateFormatPrecisionDay, culture),
