...
namespace ClearHl7.V290.Segments
{
    ...
    public class ObxSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ObservationValueAbsentReason = segments.Length > 32 && segments[32].Length > 0 ? segments[32].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ObservationRelatedSpecimenIdentifier = segments.Length > 33 && segments[33].Length > 0 ? segments[33].Split(separator).Select(x => TypeHelper.Deserialize<EntityIdentifierPair>(x, false)) : null;
        }
