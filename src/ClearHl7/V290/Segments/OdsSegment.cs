...
namespace ClearHl7.V290.Segments
{
    ...
    public class OdsSegment : ISegment
    {
        ...
        public OdsSegment FromDelimitedString(string delimitedString)
        {
            ...
            DietSupplementOrPreferenceCode = segments.Length > 3 ? segments.ElementAtOrDefault(3).Split(separator).Select(x => new CodedWithExceptions().FromDelimitedString(x)) : null;
