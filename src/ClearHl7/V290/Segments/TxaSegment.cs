...
namespace ClearHl7.V290.Segments
{
    ...
    public class TxaSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            CreatingFacility = segments.Length > 27 ? TypeHelper.Deserialize<HierarchicDesignator>(segments.ElementAtOrDefault(27), false) : null;
            CreatingSpecialty = segments.Length > 28 ? TypeHelper.Deserialize<CodedWithExceptions>(segments.ElementAtOrDefault(28), false) : null;
        }
