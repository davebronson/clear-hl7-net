...
namespace ClearHl7.V290.Types
{
    ...
    public class PerformingPersonTimeStamp : IType
    {
        ...
        public PerformingPersonTimeStamp FromDelimitedString(string delimitedString)
        {
            ...
            NameContext = segments.Length > 16 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(16)) : null;
            ...
            AssigningJurisdiction = segments.Length > 22 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(22)) : null;
            AssigningAgencyOrDepartment = segments.Length > 23 ? new CodedWithExceptions().FromDelimitedString(segments.ElementAtOrDefault(23)) : null;
