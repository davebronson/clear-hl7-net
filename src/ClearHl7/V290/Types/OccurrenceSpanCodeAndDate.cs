...
namespace ClearHl7.V290.Types
{
    ...
    public class OccurrenceSpanCodeAndDate : IType
    {
        ...
        /// <para>Suggested: 0351 Occurrence Span -&gt; ClearHl7.Codes.V290.CodeOccurrenceSpan</para>
        /// </summary>
        ...
        public OccurrenceSpanCodeAndDate FromDelimitedString(string delimitedString)
        {
            ...
            OccurrenceSpanCode = segments.Length > 0 ? new CodedWithNoExceptions().FromDelimitedString(segments.ElementAtOrDefault(0)) : null;
