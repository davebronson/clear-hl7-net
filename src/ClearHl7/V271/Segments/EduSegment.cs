...
namespace ClearHl7.V271.Segments
{
    ...
    public class EduSegment : ISegment
    {
        ...
        /// <para>Suggested: 0360 Degree/License/Certificate -&gt; ClearHl7.Codes.V271.CodeDegreeLicenseCertificate</para>
        /// </summary>
        ...
        /// <para>Suggested: 0402 School Type -&gt; ClearHl7.Codes.V271.CodeSchoolType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            MajorFieldOfStudy = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
        }
