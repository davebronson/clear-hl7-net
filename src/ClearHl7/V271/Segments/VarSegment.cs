...
namespace ClearHl7.V271.Segments
{
    ...
    public class VarSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            VarianceInstanceId = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[1], false) : null;
            ...
            VarianceOriginator = segments.Length > 4 && segments[4].Length > 0 ? segments[4].Split(separator).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false)) : null;
            VarianceClassification = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[5], false) : null;
            VarianceDescription = segments.Length > 6 && segments[6].Length > 0 ? segments[6].Split(separator) : null;
        }
