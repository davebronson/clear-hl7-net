...
namespace ClearHl7.V271.Segments
{
    ...
    public class QriSegment : ISegment
    {
        ...
        /// <para>Suggested: 0392 Match Reason -&gt; ClearHl7.Codes.V271.CodeMatchReason</para>
        /// </summary>
        public IEnumerable<CodedWithExceptions> MatchReasonCode { get; set; }

        /// <summary>
        /// QRI.3 - Algorithm Descriptor.
        /// <para>Suggested: 0393 Match Algorithms -&gt; ClearHl7.Codes.V271.CodeMatchAlgorithms</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            MatchReasonCode = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            AlgorithmDescriptor = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[3], false, seps) : null;
        }
