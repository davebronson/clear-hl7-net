...
namespace ClearHl7.V271.Segments
{
    ...
    public class ScdSegment : ISegment
    {
        ...
        /// <para>Suggested: 0682 Device Status -&gt; ClearHl7.Codes.V271.CodeDeviceStatus</para>
        /// </summary>
        ...
        /// <summary>
        /// SCD.28 - Cycle Type.
        /// <para>Suggested: 0702 Cycle Type -&gt; ClearHl7.Codes.V271.CodeCycleType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            TempMax = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[3], false, seps) : null;
            TempMin = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[4], false, seps) : null;
            LoadNumber = segments.Length > 5 && segments[5].Length > 0 ? segments[5].ToNullableDecimal() : null;
            ConditionTime = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[6], false, seps) : null;
            SterilizeTime = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[7], false, seps) : null;
            ExhaustTime = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[8], false, seps) : null;
            TotalCycleTime = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[9], false, seps) : null;
            DeviceStatus = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[10], false, seps) : null;
            CycleStartDateTime = segments.Length > 11 && segments[11].Length > 0 ? segments[11].ToNullableDateTime() : null;
            DryTime = segments.Length > 12 && segments[12].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[12], false, seps) : null;
            LeakRate = segments.Length > 13 && segments[13].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[13], false, seps) : null;
            ControlTemperature = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[14], false, seps) : null;
            SterilizerTemperature = segments.Length > 15 && segments[15].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[15], false, seps) : null;
            CycleCompleteTime = segments.Length > 16 && segments[16].Length > 0 ? segments[16].ToNullableDateTime() : null;
            UnderTemperature = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[17], false, seps) : null;
            OverTemperature = segments.Length > 18 && segments[18].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[18], false, seps) : null;
            AbortCycle = segments.Length > 19 && segments[19].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[19], false, seps) : null;
            Alarm = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[20], false, seps) : null;
            LongInChargePhase = segments.Length > 21 && segments[21].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[21], false, seps) : null;
            LongInExhaustPhase = segments.Length > 22 && segments[22].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[22], false, seps) : null;
            LongInFastExhaustPhase = segments.Length > 23 && segments[23].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[23], false, seps) : null;
            Reset = segments.Length > 24 && segments[24].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[24], false, seps) : null;
            OperatorUnload = segments.Length > 25 && segments[25].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[25], false, seps) : null;
            DoorOpen = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[26], false, seps) : null;
            ReadingFailure = segments.Length > 27 && segments[27].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[27], false, seps) : null;
            CycleType = segments.Length > 28 && segments[28].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[28], false, seps) : null;
            ThermalRinseTime = segments.Length > 29 && segments[29].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[29], false, seps) : null;
            WashTime = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[30], false, seps) : null;
            InjectionRate = segments.Length > 31 && segments[31].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[31], false, seps) : null;
            ProcedureCode = segments.Length > 32 && segments[32].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[32], false, seps) : null;
            PatientIdentifierList = segments.Length > 33 && segments[33].Length > 0 ? segments[33].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            AttendingDoctor = segments.Length > 34 && segments[34].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[34], false, seps) : null;
            DilutionFactor = segments.Length > 35 && segments[35].Length > 0 ? TypeHelper.Deserialize<StructuredNumeric>(segments[35], false, seps) : null;
            FillTime = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[36], false, seps) : null;
            InletTemperature = segments.Length > 37 && segments[37].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[37], false, seps) : null;
        }
