...
namespace ClearHl7.V271.Segments
{
    ...
    public class PeoSegment : ISegment
    {
        ...
        /// <para>Suggested: 0237 Event Qualification -&gt; ClearHl7.Codes.V271.CodeEventQualification</para>
        /// </summary>
        public IEnumerable<string> EventQualification { get; set; }

        /// <summary>
        /// PEO.9 - Event Serious.
        /// <para>Suggested: 0238 Event Seriousness -&gt; ClearHl7.Codes.V271.CodeEventSeriousness</para>
        /// </summary>
        public string EventSerious { get; set; }

        /// <summary>
        /// PEO.10 - Event Expected.
        /// <para>Suggested: 0239 Event Expected -&gt; ClearHl7.Codes.V271.CodeEventExpected</para>
        /// </summary>
        public string EventExpected { get; set; }

        /// <summary>
        /// PEO.11 - Event Outcome.
        /// <para>Suggested: 0240 Event Consequence -&gt; ClearHl7.Codes.V271.CodeEventConsequence</para>
        /// </summary>
        public IEnumerable<string> EventOutcome { get; set; }

        /// <summary>
        /// PEO.12 - Patient Outcome.
        /// <para>Suggested: 0241 Patient Outcome -&gt; ClearHl7.Codes.V271.CodePatientOutcome</para>
        /// </summary>
        ...
        /// <para>Suggested: 0242 Primary Observer's Qualification -&gt; ClearHl7.Codes.V271.CodePrimaryObserversQualification</para>
        /// </summary>
        ...
        /// <para>Suggested: 0243 Identity May Be Divulged -&gt; ClearHl7.Codes.V271.CodeIdentityMayBeDivulged</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            EventIdentifiersUsed = segments.Length > 1 && segments[1].Length > 0 ? segments[1].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            EventSymptomDiagnosisCode = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            CauseOfDeath = segments.Length > 18 && segments[18].Length > 0 ? segments[18].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
