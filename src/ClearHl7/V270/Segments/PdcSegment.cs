...
namespace ClearHl7.V270.Segments
{
    ...
    public class PdcSegment : ISegment
    {
        ...
        /// <para>Suggested: 0330 Marketing Basis -&gt; ClearHl7.Codes.V270.CodeMarketingBasis</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            Country = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[2], false, seps) : null;
            ...
            GenericName = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[5], false, seps) : null;
            ...
            ProductCode = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[9], false, seps) : null;
