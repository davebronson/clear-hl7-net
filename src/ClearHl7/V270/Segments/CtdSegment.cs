...
namespace ClearHl7.V270.Segments
{
    ...
    public class CtdSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ContactRole = segments.Length > 1 && segments[1].Length > 0 ? segments[1].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            ContactIdentifiers = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(separator).Select(x => TypeHelper.Deserialize<PractitionerLicenseOrOtherIdNumber>(x, false)) : null;
        }
