...
namespace ClearHl7.V270.Segments
{
    ...
    public class RolSegment : ISegment
    {
        ...
        /// <summary>
        /// ROL.3 - Role-ROL.
        /// <para>Suggested: 0443 Provider Role -&gt; ClearHl7.Codes.V270.CodeProviderRole</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            Organization = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(segments[14], false) : null;
        }
