...
namespace ClearHl7.V270.Segments
{
    ...
    public class TxaSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            FolderAssignment = segments.Length > 24 && segments[24].Length > 0 ? segments[24].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            DocumentTitle = segments.Length > 25 && segments[25].Length > 0 ? segments[25].Split(separator) : null;
