...
namespace ClearHl7.V251.Segments
{
    ...
    public class CnsSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            StartingNotificationCode = segments.Length > 5 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(5), false) : null;
            EndingNotificationCode = segments.Length > 6 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(6), false) : null;
        }
