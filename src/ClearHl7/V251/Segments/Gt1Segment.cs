...
namespace ClearHl7.V251.Segments
{
    ...
    public class Gt1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            GuarantorDateTimeOfBirth = segments.ElementAtOrDefault(8)?.ToNullableDateTime();
            ...
            GuarantorDateBegin = segments.ElementAtOrDefault(13)?.ToNullableDateTime();
            GuarantorDateEnd = segments.ElementAtOrDefault(14)?.ToNullableDateTime();
            ...
            GuarantorDeathDateAndTime = segments.ElementAtOrDefault(24)?.ToNullableDateTime();
            ...
            GuarantorHireEffectiveDate = segments.ElementAtOrDefault(31)?.ToNullableDateTime();
            EmploymentStopDate = segments.ElementAtOrDefault(32)?.ToNullableDateTime();
