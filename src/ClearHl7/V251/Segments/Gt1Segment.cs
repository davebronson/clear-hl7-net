...
namespace ClearHl7.V251.Segments
{
    ...
    public class Gt1Segment : ISegment
    {
        ...
        /// <para>Suggested: 0001 Administrative Sex -&gt; ClearHl7.Codes.V251.CodeAdministrativeSex</para>
        /// </summary>
        ...
        /// <para>Suggested: 0066 Employment Status -&gt; ClearHl7.Codes.V251.CodeEmploymentStatus</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            GuarantorRelationship = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[11], false, seps) : null;
            ...
            GuarantorCreditRatingCode = segments.Length > 23 && segments[23].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[23], false, seps) : null;
            ...
            GuarantorChargeAdjustmentCode = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[26], false, seps) : null;
            ...
            GuarantorMaritalStatusCode = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[30], false, seps) : null;
            ...
            AmbulatoryStatus = segments.Length > 34 && segments[34].Length > 0 ? segments[34].Split(seps.FieldRepeatSeparator, StringSplitOptions.None) : null;
            Citizenship = segments.Length > 35 && segments[35].Length > 0 ? segments[35].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            PrimaryLanguage = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[36], false, seps) : null;
            LivingArrangement = segments.Length > 37 && segments[37].Length > 0 ? segments[37] : null;
            PublicityCode = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[38], false, seps) : null;
            ...
            Religion = segments.Length > 41 && segments[41].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[41], false, seps) : null;
            ...
            Nationality = segments.Length > 43 && segments[43].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[43], false, seps) : null;
            EthnicGroup = segments.Length > 44 && segments[44].Length > 0 ? segments[44].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            ContactReason = segments.Length > 47 && segments[47].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[47], false, seps) : null;
            ...
            GuarantorRace = segments.Length > 55 && segments[55].Length > 0 ? segments[55].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            GuarantorBirthPlace = segments.Length > 56 && segments[56].Length > 0 ? segments[56] : null;
            VipIndicator = segments.Length > 57 && segments[57].Length > 0 ? segments[57] : null;
        }
