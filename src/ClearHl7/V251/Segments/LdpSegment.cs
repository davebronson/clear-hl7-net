...
namespace ClearHl7.V251.Segments
{
    ...
    public class LdpSegment : ISegment
    {
        ...
        /// <para>Suggested: 0265 Specialty Type -&gt; ClearHl7.Codes.V251.CodeSpecialtyType</para>
        /// </summary>
        ...
        /// <para>Suggested: 0267 Days Of The Week -&gt; ClearHl7.Codes.V251.CodeDaysOfTheWeek</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            LocationDepartment = segments.Length > 2 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(2), false) : null;
            LocationService = segments.Length > 3 ? segments.ElementAtOrDefault(3).Split(separator) : null;
            SpecialtyType = segments.Length > 4 ? segments.ElementAtOrDefault(4).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ValidPatientClasses = segments.Length > 5 ? segments.ElementAtOrDefault(5).Split(separator) : null;
            ...
            LocationCostCenter = segments.Length > 12 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(12), false) : null;
        }
