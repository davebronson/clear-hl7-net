...
namespace ClearHl7.V251.Segments
{
    ...
    public class RolSegment : ISegment
    {
        ...
        /// <summary>
        /// ROL.3 - Role-ROL.
        /// <para>Suggested: 0443 Provider Role -&gt; ClearHl7.Codes.V251.CodeProviderRole</para>
        /// </summary>
        ...
        /// <para>Suggested: 0406 Participant Organization Unit Type -&gt; ClearHl7.Codes.V251.CodeParticipantOrganizationUnitType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            RoleRol = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[3], false, seps) : null;
            ...
            RoleDuration = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[7], false, seps) : null;
            RoleActionReason = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[8], false, seps) : null;
            ProviderType = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            OrganizationUnitType = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[10], false, seps) : null;
