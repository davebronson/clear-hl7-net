...
namespace ClearHl7.V251.Segments
{
    ...
    public class RxrSegment : ISegment
    {
        ...
        /// <summary>
        /// RXR.1 - Route.
        /// <para>Suggested: 0162 Route Of Administration -&gt; ClearHl7.Codes.V251.CodeRouteOfAdministration</para>
        /// </summary>
        ...
        /// <para>Suggested: 0164 Administration Device -&gt; ClearHl7.Codes.V251.CodeAdministrationDevice</para>
        /// </summary>
        public CodedElement AdministrationDevice { get; set; }

        /// <summary>
        /// RXR.4 - Administration Method.
        /// <para>Suggested: 0165 Administration Method -&gt; ClearHl7.Codes.V251.CodeAdministrationMethod</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            Route = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[1], false) : null;
            ...
            AdministrationDevice = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[3], false) : null;
            ...
            RoutingInstruction = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[5], false) : null;
