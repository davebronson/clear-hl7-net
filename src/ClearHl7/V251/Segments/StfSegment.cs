...
namespace ClearHl7.V251.Segments
{
    ...
    public class StfSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            EmploymentStatusCode = segments.Length > 20 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(20), false) : null;
            ...
            Race = segments.Length > 27 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(27), false) : null;
            EthnicGroup = segments.Length > 28 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(28), false) : null;
            ReactivationApprovalIndicator = segments.ElementAtOrDefault(29);
            Citizenship = segments.Length > 30 ? segments.ElementAtOrDefault(30).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
