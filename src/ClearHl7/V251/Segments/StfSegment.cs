...
namespace ClearHl7.V251.Segments
{
    ...
    public class StfSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            StaffType = segments.Length > 4 && segments[4].Length > 0 ? segments[4].Split(separator) : null;
            ...
            Department = segments.Length > 8 && segments[8].Length > 0 ? segments[8].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            HospitalServiceStf = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            BackupPersonId = segments.Length > 14 && segments[14].Length > 0 ? segments[14].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            EmailAddress = segments.Length > 15 && segments[15].Length > 0 ? segments[15].Split(separator) : null;
            PreferredMethodOfContact = segments.Length > 16 && segments[16].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[16], false) : null;
            MaritalStatus = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[17], false) : null;
            ...
            EmploymentStatusCode = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[20], false) : null;
            ...
            Race = segments.Length > 27 && segments[27].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[27], false) : null;
            EthnicGroup = segments.Length > 28 && segments[28].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[28], false) : null;
            ReactivationApprovalIndicator = segments.Length > 29 && segments[29].Length > 0 ? segments[29] : null;
            Citizenship = segments.Length > 30 && segments[30].Length > 0 ? segments[30].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
