...
namespace ClearHl7.V251.Segments
{
    ...
    public class AisSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            PlacerSupplementalServiceInformation = segments.Length > 11 && segments[11].Length > 0 ? segments[11].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            FillerSupplementalServiceInformation = segments.Length > 12 && segments[12].Length > 0 ? segments[12].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
        }
