...
namespace ClearHl7.V251.Segments
{
    ...
    public class ErqSegment : ISegment
    {
        ...
        public ErqSegment FromDelimitedString(string delimitedString)
        {
            ...
            EventIdentifier = segments.Length > 2 ? new CodedElement().FromDelimitedString(segments.ElementAtOrDefault(2)) : null;
            InputParameterList = segments.Length > 3 ? new QueryInputParameterList().FromDelimitedString(segments.ElementAtOrDefault(3)) : null;
