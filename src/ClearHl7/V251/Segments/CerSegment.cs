...
namespace ClearHl7.V251.Segments
{
    ...
    public class CerSegment : ISegment
    {
        ...
        /// <para>Suggested: 0547 Jurisdictional Breadth -&gt; ClearHl7.Codes.V251.CodeJurisdictionalBreadth</para>
        /// </summary>
        ...
        /// </summary>
        public CodedElement RevocationReasonCode { get; set; }

        /// <summary>
        /// CER.31 - Certificate Status Code.
        /// <para>Suggested: 0536 Certificate Status -&gt; ClearHl7.Codes.V251.CodeCertificateStatus</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            SubjectId = segments.Length > 12 && segments[12].Length > 0 ? segments[12] : null;
            ...
            RevocationReasonCode = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[30], false, seps) : null;
