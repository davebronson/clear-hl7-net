...
namespace ClearHl7.V251.Segments
{
    ...
    public class In2Segment : ISegment
    {
        ...
        /// <para>Suggested: 0137 Mail Claim Party -&gt; ClearHl7.Codes.V251.CodeMailClaimParty</para>
        /// </summary>
        ...
        /// <para>Suggested: 0144 Eligibility Source -&gt; ClearHl7.Codes.V251.CodeEligibilitySource</para>
        /// </summary>
        ...
        /// <summary>
        /// IN2.39 - Religion.
        /// <para>Suggested: 0006 Religion -&gt; ClearHl7.Codes.V251.CodeReligion</para>
        /// </summary>
        ...
        /// <summary>
        /// IN2.42 - Ethnic Group.
        /// <para>Suggested: 0189 Ethnic Group -&gt; ClearHl7.Codes.V251.CodeEthnicGroup</para>
        /// </summary>
        public IEnumerable<CodedElement> EthnicGroup { get; set; }

        /// <summary>
        /// IN2.43 - Marital Status.
        /// <para>Suggested: 0002 Marital Status -&gt; ClearHl7.Codes.V251.CodeMaritalStatus</para>
        /// </summary>
        ...
        /// <summary>
        /// IN2.48 - Job Status.
        /// <para>Suggested: 0311 Job Status -&gt; ClearHl7.Codes.V251.CodeJobStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0232 Insurance Company Contact Reason -&gt; ClearHl7.Codes.V251.CodeInsuranceCompanyContactReason</para>
        /// </summary>
        ...
        /// <para>Suggested: 0063 Relationship -&gt; ClearHl7.Codes.V251.CodeRelationship</para>
        /// </summary>
        ...
        /// <summary>
        /// IN2.71 - Race.
        /// <para>Suggested: 0005 Race -&gt; ClearHl7.Codes.V251.CodeRace</para>
        /// </summary>
        public IEnumerable<CodedElement> Race { get; set; }

        /// <summary>
        /// IN2.72 - Patient's Relationship to Insured.
        /// <para>Suggested: 0344 Patient's Relationship to Insured -&gt; ClearHl7.Codes.V251.CodePatientsRelationshiptoInsured</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            DependentOfMilitaryRecipient = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[11], false, seps) : null;
            ...
            MilitaryService = segments.Length > 14 && segments[14].Length > 0 ? segments[14] : null;
            MilitaryRankGrade = segments.Length > 15 && segments[15].Length > 0 ? segments[15] : null;
            MilitaryStatus = segments.Length > 16 && segments[16].Length > 0 ? segments[16] : null;
            ...
            AmbulatoryStatus = segments.Length > 32 && segments[32].Length > 0 ? segments[32].Split(seps.FieldRepeatSeparator, StringSplitOptions.None) : null;
            Citizenship = segments.Length > 33 && segments[33].Length > 0 ? segments[33].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            PrimaryLanguage = segments.Length > 34 && segments[34].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[34], false, seps) : null;
            LivingArrangement = segments.Length > 35 && segments[35].Length > 0 ? segments[35] : null;
            PublicityCode = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[36], false, seps) : null;
            ProtectionIndicator = segments.Length > 37 && segments[37].Length > 0 ? segments[37] : null;
            StudentIndicator = segments.Length > 38 && segments[38].Length > 0 ? segments[38] : null;
            Religion = segments.Length > 39 && segments[39].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[39], false, seps) : null;
            ...
            Nationality = segments.Length > 41 && segments[41].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[41], false, seps) : null;
            EthnicGroup = segments.Length > 42 && segments[42].Length > 0 ? segments[42].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            MaritalStatus = segments.Length > 43 && segments[43].Length > 0 ? segments[43].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            GuarantorsRelationshipToInsured = segments.Length > 62 && segments[62].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[62], false, seps) : null;
            ...
            MilitaryHandicappedProgram = segments.Length > 65 && segments[65].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[65], false, seps) : null;
            ...
            Race = segments.Length > 71 && segments[71].Length > 0 ? segments[71].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            PatientsRelationshipToInsured = segments.Length > 72 ? TypeHelper.Deserialize<CodedElement>(segments[72], false, seps) : null;
        }
