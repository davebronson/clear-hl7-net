...
namespace ClearHl7.V251.Segments
{
    ...
    public class In2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            DependentOfMilitaryRecipient = segments.Length > 11 && segments[11].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[11], false, seps) : null;
            ...
            Citizenship = segments.Length > 33 && segments[33].Length > 0 ? segments[33].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
            PrimaryLanguage = segments.Length > 34 && segments[34].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[34], false, seps) : null;
            LivingArrangement = segments.Length > 35 && segments[35].Length > 0 ? segments[35] : null;
            PublicityCode = segments.Length > 36 && segments[36].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[36], false, seps) : null;
            ...
            Religion = segments.Length > 39 && segments[39].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[39], false, seps) : null;
            ...
            Nationality = segments.Length > 41 && segments[41].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[41], false, seps) : null;
            EthnicGroup = segments.Length > 42 && segments[42].Length > 0 ? segments[42].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
            MaritalStatus = segments.Length > 43 && segments[43].Length > 0 ? segments[43].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            GuarantorsRelationshipToInsured = segments.Length > 62 && segments[62].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[62], false, seps) : null;
            ...
            MilitaryHandicappedProgram = segments.Length > 65 && segments[65].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[65], false, seps) : null;
            ...
            Race = segments.Length > 71 && segments[71].Length > 0 ? segments[71].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
            PatientsRelationshipToInsured = segments.Length > 72 ? TypeSerializer.Deserialize<CodedElement>(segments[72], false, seps) : null;
        }
