...
namespace ClearHl7.V251.Segments
{
    ...
    public class In2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            AmbulatoryStatus = segments.Length > 32 && segments[32].Length > 0 ? segments[32].Split(separator) : null;
            Citizenship = segments.Length > 33 && segments[33].Length > 0 ? segments[33].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            PrimaryLanguage = segments.Length > 34 && segments[34].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[34], false) : null;
            LivingArrangement = segments.Length > 35 && segments[35].Length > 0 ? segments[35] : null;
            PublicityCode = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[36], false) : null;
            ...
            Religion = segments.Length > 39 && segments[39].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[39], false) : null;
            ...
            EthnicGroup = segments.Length > 42 && segments[42].Length > 0 ? segments[42].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            MaritalStatus = segments.Length > 43 && segments[43].Length > 0 ? segments[43].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            GuarantorsRelationshipToInsured = segments.Length > 62 && segments[62].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[62], false) : null;
            ...
            Race = segments.Length > 71 && segments[71].Length > 0 ? segments[71].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
