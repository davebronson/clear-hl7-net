...
namespace ClearHl7.V251.Segments
{
    ...
    public class IimSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ProcedureCode = segments.Length > 14 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(14), false) : null;
            ProcedureCodeModifier = segments.Length > 15 ? segments.ElementAtOrDefault(15).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
        }
