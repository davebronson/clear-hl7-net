...
namespace ClearHl7.V251.Segments
{
    ...
    public class ObrSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            PlacerSupplementalServiceInformation = segments.Length > 46 && segments[46].Length > 0 ? segments[46].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            FillerSupplementalServiceInformation = segments.Length > 47 && segments[47].Length > 0 ? segments[47].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
