...
namespace ClearHl7.V251.Segments
{
    ...
    public class TcdSegment : ISegment
    {
        ...
        /// <para>Suggested: 0389 Analyte Repeat Status -&gt; ClearHl7.Codes.V251.CodeAnalyteRepeatStatus</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            AnalyteRepeatStatus = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[8], false) : null;
        }
