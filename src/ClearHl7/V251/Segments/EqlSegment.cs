...
namespace ClearHl7.V251.Segments
{
    ...
    public class EqlSegment : ISegment
    {
        ...
        public EqlSegment FromDelimitedString(string delimitedString)
        {
            ...
            EqlQueryName = segments.Length > 3 ? new CodedElement().FromDelimitedString(segments.ElementAtOrDefault(3)) : null;
