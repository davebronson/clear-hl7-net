...
namespace ClearHl7.V251.Segments
{
    ...
    public class PraSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            PrimaryKeyValuePra = segments.Length > 1 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(1), false) : null;
            ...
            Institution = segments.Length > 9 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(9), false) : null;
            DateLeftPractice = segments.ElementAtOrDefault(10)?.ToNullableDateTime();
            GovernmentReimbursementBillingEligibility = segments.Length > 11 ? segments.ElementAtOrDefault(11).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
