...
namespace ClearHl7.V251.Segments
{
    ...
    public class PidSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            PatientAlias = segments.Length > 9 ? TypeHelper.Deserialize<ExtendedPersonName>(segments.ElementAtOrDefault(9), false) : null;
            ...
            IdentityReliabilityCode = segments.Length > 32 ? segments.ElementAtOrDefault(32).Split(separator) : null;
            ...
            TaxonomicClassificationCode = segments.Length > 35 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(35), false) : null;
            BreedCode = segments.Length > 36 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(36), false) : null;
            Strain = segments.ElementAtOrDefault(37);
            ProductionClassCode = segments.Length > 38 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(38), false) : null;
