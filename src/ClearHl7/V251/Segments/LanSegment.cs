...
namespace ClearHl7.V251.Segments
{
    ...
    public class LanSegment : ISegment
    {
        ...
        /// <para>Suggested: 0403 Language Ability -&gt; ClearHl7.Codes.V251.CodeLanguageAbility</para>
        /// </summary>
        public IEnumerable<CodedElement> LanguageAbilityCode { get; set; }

        /// <summary>
        /// LAN.4 - Language Proficiency Code.
        /// <para>Suggested: 0404 Language Proficiency -&gt; ClearHl7.Codes.V251.CodeLanguageProficiency</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            LanguageCode = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[2], false, seps) : null;
            LanguageAbilityCode = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            LanguageProficiencyCode = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[4], false, seps) : null;
        }
