...
namespace ClearHl7.V251.Segments
{
    ...
    public class Om3Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            AbnormalTextCodesForCategoricalObservations = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            CriticalTextCodesForCategoricalObservations = segments.Length > 6 && segments[6].Length > 0 ? segments[6].Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
