...
namespace ClearHl7.V280.Types
{
    ...
    public class PolicyTypeAndAmount : IType
    {
        ...
        /// <summary>
        /// PTA.1 - Policy Type.
        /// <para>Suggested: 0147 Policy Type -&gt; ClearHl7.Codes.V280.CodePolicyType</para>
        /// </summary>
        public CodedWithExceptions PolicyType { get; set; }

        /// <summary>
        /// PTA.2 - Amount Class.
        /// <para>Suggested: 0193 Amount Class -&gt; ClearHl7.Codes.V280.CodeAmountClass</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            PolicyType = segments.Length > 0 && segments[0].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[0], true, seps) : null;
            AmountClass = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[1], true, seps) : null;
