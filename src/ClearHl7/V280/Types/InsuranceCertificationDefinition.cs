...
namespace ClearHl7.V280.Types
{
    ...
    public class InsuranceCertificationDefinition : IType
    {
        ...
        /// <para>Suggested: 0150 Certification Patient Type -&gt; ClearHl7.Codes.V280.CodeCertificationPatientType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            CertificationPatientType = segments.Length > 0 && segments[0].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[0], true, seps) : null;
