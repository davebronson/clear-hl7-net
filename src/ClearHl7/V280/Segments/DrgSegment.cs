...
namespace ClearHl7.V280.Segments
{
    ...
    public class DrgSegment : ISegment
    {
        ...
        /// <para>Suggested: 0415 Transfer Type -&gt; ClearHl7.Codes.V280.CodeTransferType</para>
        /// </summary>
        ...
        /// <para>Suggested: 0734 Grouper Status -&gt; ClearHl7.Codes.V280.CodeGrouperStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0739 DRG Status Patient -&gt; ClearHl7.Codes.V280.CodeDrgStatusPatient</para>
        /// </summary>
        ...
        /// <para>Suggested: 0742 DRG Status Financial Calculation -&gt; ClearHl7.Codes.V280.CodeDrgStatusFinancialCalculation</para>
        /// </summary>
        ...
        /// <para>Suggested: 0749 DRG Grouping Status -&gt; ClearHl7.Codes.V280.CodeDrgGroupingStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0755 Status Weight At Birth -&gt; ClearHl7.Codes.V280.CodeStatusWeightAtBirth</para>
        /// </summary>
        public CodedWithExceptions StatusWeightAtBirth { get; set; }

        /// <summary>
        /// DRG.32 - Status Respiration Minutes.
        /// <para>Suggested: 0757 DRG Status Respiration Minutes -&gt; ClearHl7.Codes.V280.CodeDrgStatusRespirationMinutes</para>
        /// </summary>
        public CodedWithExceptions StatusRespirationMinutes { get; set; }

        /// <summary>
        /// DRG.33 - Status Admission.
        /// <para>Suggested: 0759 Status Admission -&gt; ClearHl7.Codes.V280.CodeStatusAdmission</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            DrgGrouperReviewCode = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[4], false, seps) : null;
            OutlierType = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[5], false, seps) : null;
            ...
            DrgPayor = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[8], false, seps) : null;
            ...
            DrgTransferType = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[11], false, seps) : null;
            NameOfCoder = segments.Length > 12 && segments[12].Length > 0 ? TypeHelper.Deserialize<ExtendedPersonName>(segments[12], false, seps) : null;
            GrouperStatus = segments.Length > 13 && segments[13].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[13], false, seps) : null;
            PcclValueCode = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[14], false, seps) : null;
            EffectiveWeight = segments.Length > 15 && segments[15].Length > 0 ? segments[15].ToNullableDecimal() : null;
            MonetaryAmount = segments.Length > 16 && segments[16].Length > 0 ? TypeHelper.Deserialize<Money>(segments[16], false, seps) : null;
            StatusPatient = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[17], false, seps) : null;
            ...
            StatusFinancialCalculation = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[20], false, seps) : null;
            RelativeDiscountSurcharge = segments.Length > 21 && segments[21].Length > 0 ? TypeHelper.Deserialize<Money>(segments[21], false, seps) : null;
            BasicCharge = segments.Length > 22 && segments[22].Length > 0 ? TypeHelper.Deserialize<Money>(segments[22], false, seps) : null;
            TotalCharge = segments.Length > 23 && segments[23].Length > 0 ? TypeHelper.Deserialize<Money>(segments[23], false, seps) : null;
            DiscountSurcharge = segments.Length > 24 && segments[24].Length > 0 ? TypeHelper.Deserialize<Money>(segments[24], false, seps) : null;
            CalculatedDays = segments.Length > 25 && segments[25].Length > 0 ? segments[25].ToNullableDecimal() : null;
            StatusGender = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[26], false, seps) : null;
            StatusAge = segments.Length > 27 && segments[27].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[27], false, seps) : null;
            StatusLengthOfStay = segments.Length > 28 && segments[28].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[28], false, seps) : null;
            StatusSameDayFlag = segments.Length > 29 && segments[29].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[29], false, seps) : null;
            StatusSeparationMode = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[30], false, seps) : null;
            StatusWeightAtBirth = segments.Length > 31 && segments[31].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[31], false, seps) : null;
            StatusRespirationMinutes = segments.Length > 32 && segments[32].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[32], false, seps) : null;
            StatusAdmission = segments.Length > 33 && segments[33].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[33], false, seps) : null;
        }
