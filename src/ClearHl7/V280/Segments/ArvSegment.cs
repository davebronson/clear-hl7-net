...
namespace ClearHl7.V280.Segments
{
    ...
    public class ArvSegment : ISegment
    {
        ...
        /// <para>Suggested: 0717 Access Restriction Value -&gt; ClearHl7.Fhir.Codes.V280.CodeAccessRestrictionValue</para>
        /// </summary>
        public CodedWithExceptions AccessRestrictionValue { get; set; }

        /// <summary>
        /// ARV.4 - Access Restriction Reason.
        /// <para>Suggested: 0719 Access Restriction Reason Code -&gt; ClearHl7.Fhir.Codes.V280.CodeAccessRestrictionReasonCode</para>
        /// </summary>
