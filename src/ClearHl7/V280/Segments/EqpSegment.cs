...
namespace ClearHl7.V280.Segments
{
    ...
    public class EqpSegment : ISegment
    {
        ...
        /// <summary>
        /// EQP.1 - Event type.
        /// <para>Suggested: 0450 Event Type -&gt; ClearHl7.Codes.V280.CodeEventType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            EventType = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[1], false, seps) : null;
