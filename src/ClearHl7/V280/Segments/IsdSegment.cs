...
namespace ClearHl7.V280.Segments
{
    ...
    public class IsdSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            InteractionTypeIdentifier = segments.Length > 2 ? TypeHelper.Deserialize<CodedWithExceptions>(segments.ElementAtOrDefault(2), false) : null;
            InteractionActiveState = segments.Length > 3 ? TypeHelper.Deserialize<CodedWithExceptions>(segments.ElementAtOrDefault(3), false) : null;
        }
