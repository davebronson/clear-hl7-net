...
namespace ClearHl7.V280.Segments
{
    ...
    public class Om5Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            TestObservationsIncludedWithinAnOrderedTestBattery = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
