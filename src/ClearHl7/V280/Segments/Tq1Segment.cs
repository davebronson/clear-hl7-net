...
namespace ClearHl7.V280.Segments
{
    ...
    public class Tq1Segment : ISegment
    {
        ...
        /// <summary>
        /// TQ1.9 - Priority.
        /// <para>Suggested: 0485 Extended Priority Codes -&gt; ClearHl7.Codes.V280.CodeExtendedPriorityCodes</para>
        /// </summary>
        ...
        /// <summary>
        /// TQ1.12 - Conjunction.
        /// <para>Suggested: 0472 TQ Conjunction ID -&gt; ClearHl7.Codes.V280.CodeTqConjunctionId</para>
        /// </summary>
        ...
        internal void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            RepeatPattern = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<RepeatPattern>(x, false)) : null;
            ...
            RelativeTimeAndUnits = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CompositeQuantityWithUnits>(x, false)) : null;
            ...
            Priority = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
