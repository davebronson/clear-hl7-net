...
namespace ClearHl7.V260.Segments
{
    ...
    public class BtxSegment : ISegment
    {
        ...
        /// <para>Suggested: 0513 Blood Product Transfusion/Disposition Status -&gt; ClearHl7.Codes.V260.CodeBloodProductTransfusionDispositionStatus</para>
        /// </summary>
        public CodedWithExceptions BpTransfusionDispositionStatus { get; set; }

        /// <summary>
        /// BTX.12 - BP Message Status.
        /// <para>Suggested: 0511 BP Observation Status Codes Interpretation -&gt; ClearHl7.Codes.V260.CodeBpObservationStatusCodesInterpretation</para>
        /// </summary>
        ...
        /// <para>Suggested: 0514 Transfusion Adverse Reaction -&gt; ClearHl7.Codes.V260.CodeTransfusionAdverseReaction</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            BpUnits = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[10], false, seps) : null;
