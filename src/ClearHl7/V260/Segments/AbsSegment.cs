...
namespace ClearHl7.V260.Segments
{
    ...
    public class AbsSegment : ISegment
    {
        ...
        /// <para>Suggested: 0421 Severity Of Illness Code -&gt; ClearHl7.Codes.V260.CodeSeverityOfIllnessCode</para>
        /// </summary>
        ...
        /// <summary>
        /// ABS.6 - Triage Code.
        /// <para>Suggested: 0422 Triage Code -&gt; ClearHl7.Codes.V260.CodeTriageCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0423 Case Category Code -&gt; ClearHl7.Codes.V260.CodeCaseCategoryCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0424 Gestation Category Code -&gt; ClearHl7.Codes.V260.CodeGestationCategoryCode</para>
        /// </summary>
        ...
        /// <summary>
        /// ABS.13 - Newborn Code.
        /// <para>Suggested: 0425 Newborn Code -&gt; ClearHl7.Codes.V260.CodeNewbornCode</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            DischargeCareProvider = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[1], false, seps) : null;
            TransferMedicalServiceCode = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[2], false, seps) : null;
            SeverityOfIllnessCode = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[3], false, seps) : null;
            DateTimeOfAttestation = segments.Length > 4 && segments[4].Length > 0 ? segments[4].ToNullableDateTime() : null;
            AttestedBy = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[5], false, seps) : null;
            TriageCode = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[6], false, seps) : null;
            AbstractCompletionDateTime = segments.Length > 7 && segments[7].Length > 0 ? segments[7].ToNullableDateTime() : null;
            AbstractedBy = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(segments[8], false, seps) : null;
            CaseCategoryCode = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[9], false, seps) : null;
            CaesarianSectionIndicator = segments.Length > 10 && segments[10].Length > 0 ? segments[10] : null;
            GestationCategoryCode = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[11], false, seps) : null;
            GestationPeriodWeeks = segments.Length > 12 && segments[12].Length > 0 ? segments[12].ToNullableDecimal() : null;
            NewbornCode = segments.Length > 13 && segments[13].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[13], false, seps) : null;
