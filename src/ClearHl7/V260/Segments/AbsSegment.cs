...
namespace ClearHl7.V260.Segments
{
    ...
    public class AbsSegment : ISegment
    {
        ...
        internal void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            TransferMedicalServiceCode = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[2], false) : null;
            SeverityOfIllnessCode = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[3], false) : null;
            ...
            TriageCode = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[6], false) : null;
            ...
            CaseCategoryCode = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[9], false) : null;
            CaesarianSectionIndicator = segments.Length > 10 && segments[10].Length > 0 ? segments[10] : null;
            GestationCategoryCode = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[11], false) : null;
            GestationPeriodWeeks = segments.Length > 12 && segments[12].Length > 0 ? segments[12].ToNullableDecimal() : null;
            NewbornCode = segments.Length > 13 && segments[13].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[13], false) : null;
