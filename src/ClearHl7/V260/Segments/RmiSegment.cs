...
namespace ClearHl7.V260.Segments
{
    ...
    public class RmiSegment : ISegment
    {
        ...
        /// <para>Suggested: 0427 Risk Management Incident Code -&gt; ClearHl7.Codes.V260.CodeRiskManagementIncidentCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0428 Incident Type Code -&gt; ClearHl7.Codes.V260.CodeIncidentTypeCode</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            RiskManagementIncidentCode = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[1], false, seps) : null;
            DateTimeIncident = segments.Length > 2 && segments[2].Length > 0 ? segments[2].ToNullableDateTime() : null;
            IncidentTypeCode = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[3], false, seps) : null;
        }
