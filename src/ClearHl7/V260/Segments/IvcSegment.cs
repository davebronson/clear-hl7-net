...
namespace ClearHl7.V260.Segments
{
    ...
    public class IvcSegment : ISegment
    {
        ...
        /// <para>Suggested: 0553 Invoice Control Code -&gt; ClearHl7.Codes.V260.CodeInvoiceControlCode</para>
        /// </summary>
        public string InvoiceControl { get; set; }

        /// <summary>
        /// IVC.5 - Invoice Reason.
        /// <para>Suggested: 0554 Invoice Reason Codes -&gt; ClearHl7.Codes.V260.CodeInvoiceReasonCodes</para>
        /// </summary>
        public string InvoiceReason { get; set; }

        /// <summary>
        /// IVC.6 - Invoice Type.
        /// <para>Suggested: 0555 Invoice Type -&gt; ClearHl7.Codes.V260.CodeInvoiceType</para>
        /// </summary>
        ...
        /// <para>Suggested: 0556 Benefit Group -&gt; ClearHl7.Codes.V260.CodeBenefitGroup</para>
        /// </summary>
        ...
        /// <para>Suggested: 0572 Tax Status -&gt; ClearHl7.Codes.V260.CodeTaxStatus</para>
        /// </summary>
        public string ProviderTaxStatus { get; set; }

        /// <summary>
        /// IVC.29 - Payer Tax Status.
        /// <para>Suggested: 0572 Tax Status -&gt; ClearHl7.Codes.V260.CodeTaxStatus</para>
        /// </summary>
        public string PayerTaxStatus { get; set; }
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            InvoiceControl = segments.Length > 4 && segments[4].Length > 0 ? segments[4] : null;
            InvoiceReason = segments.Length > 5 && segments[5].Length > 0 ? segments[5] : null;
            InvoiceType = segments.Length > 6 && segments[6].Length > 0 ? segments[6] : null;
            ...
            BenefitGroup = segments.Length > 25 && segments[25].Length > 0 ? segments[25] : null;
            ...
            ProviderTaxStatus = segments.Length > 28 && segments[28].Length > 0 ? segments[28] : null;
            PayerTaxStatus = segments.Length > 29 && segments[29].Length > 0 ? segments[29] : null;
