...
namespace ClearHl7.V260.Segments
{
    ...
    public class IvcSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            InvoiceControl = segments.ElementAtOrDefault(4);
            InvoiceReason = segments.ElementAtOrDefault(5);
            InvoiceType = segments.ElementAtOrDefault(6);
            ...
            BenefitGroup = segments.ElementAtOrDefault(25);
            ProviderTaxId = segments.ElementAtOrDefault(26);
            PayerTaxId = segments.ElementAtOrDefault(27);
            ProviderTaxStatus = segments.ElementAtOrDefault(28);
            PayerTaxStatus = segments.ElementAtOrDefault(29);
