...
namespace ClearHl7.V260.Segments
{
    ...
    public class ErrSegment : ISegment
    {
        ...
        /// <summary>
        /// ERR.4 - Severity.
        /// <para>Suggested: 0516 Error Severity -&gt; ClearHl7.Codes.V260.CodeErrorSeverity</para>
        /// </summary>
        ...
        /// <para>Suggested: 0517 Inform Person Code -&gt; ClearHl7.Codes.V260.CodeInformPersonCode</para>
        /// </summary>
        ...
        internal void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            InformPersonIndicator = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(seps.FieldRepeatSeparator, StringSplitOptions.None) : null;
