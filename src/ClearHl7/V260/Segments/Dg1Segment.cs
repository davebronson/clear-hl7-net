...
namespace ClearHl7.V260.Segments
{
    ...
    public class Dg1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            DrgDiagnosisDeterminationStatus = segments.Length > 25 && segments[25].Length > 0 ? segments[25] : null;
            PresentOnAdmissionPoaIndicator = segments.Length > 26 && segments[26].Length > 0 ? segments[26] : null;
        }
