...
namespace ClearHl7.V260.Segments
{
    ...
    public class IvtSegment : ISegment
    {
        ...
        /// <summary>
        /// IVT.6 - Item Status.
        /// <para>Suggested: 0625 Item Status Codes -&gt; ClearHl7.Codes.V260.CodeItemStatusCodes</para>
        /// </summary>
        ...
        /// <para>Suggested: 0634 Item Importance Codes -&gt; ClearHl7.Codes.V260.CodeItemImportanceCodes</para>
        /// </summary>
        ...
        /// <para>Suggested: 0642 Reorder Theory Codes -&gt; ClearHl7.Codes.V260.CodeReorderTheoryCodes</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            InventoryLocationIdentifier = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[2], false, seps) : null;
            InventoryLocationName = segments.Length > 3 && segments[3].Length > 0 ? segments[3] : null;
            SourceLocationIdentifier = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[4], false, seps) : null;
            SourceLocationName = segments.Length > 5 && segments[5].Length > 0 ? segments[5] : null;
            ItemStatus = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[6], false, seps) : null;
            BinLocationIdentifier = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<EntityIdentifier>(x, false, seps)) : null;
            OrderPackaging = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[8], false, seps) : null;
            IssuePackaging = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[9], false, seps) : null;
            DefaultInventoryAssetAccount = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[10], false, seps) : null;
            ...
            ItemImportanceCode = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[14], false, seps) : null;
            StockedItemIndicator = segments.Length > 15 && segments[15].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[15], false, seps) : null;
            ConsignmentItemIndicator = segments.Length > 16 && segments[16].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[16], false, seps) : null;
            ReusableItemIndicator = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[17], false, seps) : null;
            ReusableCost = segments.Length > 18 && segments[18].Length > 0 ? TypeHelper.Deserialize<CompositePrice>(segments[18], false, seps) : null;
            SubstituteItemIdentifier = segments.Length > 19 && segments[19].Length > 0 ? segments[19].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<EntityIdentifier>(x, false, seps)) : null;
            LatexFreeSubstituteItemIdentifier = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[20], false, seps) : null;
            RecommendedReorderTheory = segments.Length > 21 && segments[21].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[21], false, seps) : null;
            ...
            OperatingRoomParLevelIndicator = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<CodedWithNoExceptions>(segments[26], false, seps) : null;
        }
