...
namespace ClearHl7.V260.Segments
{
    ...
    public class MfiSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            MasterFileApplicationIdentifier = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(separator).Select(x => TypeHelper.Deserialize<HierarchicDesignator>(x, false)) : null;
