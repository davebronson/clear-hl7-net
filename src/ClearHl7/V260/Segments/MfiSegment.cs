...
namespace ClearHl7.V260.Segments
{
    ...
    public class MfiSegment : ISegment
    {
        ...
        /// <para>Suggested: 0175 Master File Identifier Code -&gt; ClearHl7.Codes.V260.CodeMasterFileIdentifierCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0178 File Level Event Code -&gt; ClearHl7.Codes.V260.CodeFileLevelEventCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0179 Response Level -&gt; ClearHl7.Codes.V260.CodeResponseLevel</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            MasterFileIdentifier = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[1], false, seps) : null;
            MasterFileApplicationIdentifier = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<HierarchicDesignator>(x, false, seps)) : null;
