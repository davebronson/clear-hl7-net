...
namespace ClearHl7.V260.Segments
{
    ...
    public class Om4Segment : ISegment
    {
        ...
        /// <para>Suggested: 0170 Derived Specimen -&gt; ClearHl7.Codes.V260.CodeDerivedSpecimen</para>
        /// </summary>
        ...
        /// <para>Suggested: 0027 Priority -&gt; ClearHl7.Codes.V260.CodePriority</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ContainerUnits = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[5], false, seps) : null;
