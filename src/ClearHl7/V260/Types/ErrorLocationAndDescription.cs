...
namespace ClearHl7.V260.Types
{
    ...
    public class ErrorLocationAndDescription : IType
    {
        ...
        public ErrorLocationAndDescription(string segmentId, decimal segmentSequence, decimal fieldPosition, CodedWithExceptions codeIdentifyingError)
        {
            SegmentId = segmentId;
        ...
        /// </summary>
        public CodedWithExceptions CodeIdentifyingError { get; set; }
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            CodeIdentifyingError = segments.Length > 3 && segments[3].Length > 0 ? TypeSerializer.Deserialize<CodedWithExceptions>(segments[3], true, seps) : null;
        }
