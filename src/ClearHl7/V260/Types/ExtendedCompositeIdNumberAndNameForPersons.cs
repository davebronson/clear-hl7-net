...
namespace ClearHl7.V260.Types
{
    ...
    public class ExtendedCompositeIdNumberAndNameForPersons : IType
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            NameContext = segments.Length > 15 && segments[15].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[15], true, seps) : null;
            ...
            AssigningJurisdiction = segments.Length > 21 && segments[21].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[21], true, seps) : null;
            AssigningAgencyOrDepartment = segments.Length > 22 && segments[22].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[22], true, seps) : null;
        }
