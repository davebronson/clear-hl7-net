...
namespace ClearHl7.V260.Types
{
    ...
    public class PerformingPersonTimeStamp : IType
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            NameContext = segments.Length > 16 && segments[16].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[16], true, seps) : null;
            NameValidityRange = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<DateTimeRange>(segments[17], true, seps) : null;
            ...
            AssigningJurisdiction = segments.Length > 22 && segments[22].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[22], true, seps) : null;
            AssigningAgencyOrDepartment = segments.Length > 23 && segments[23].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[23], true, seps) : null;
        }
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                culture,
                                StringHelper.StringFormatSequence(0, 24, separator),
                                PersonIdentifier,
