...
namespace ClearHl7.V260.Types
{
    ...
    public class ProcessingType : IType
    {
        ...
        /// <summary>
        /// PT.1 - Processing ID.
        /// <para>Suggested: 0103 Processing ID -&gt; ClearHl7.Codes.V260.CodeProcessingId</para>
        /// </summary>
        public string ProcessingId { get; set; }

        /// <summary>
        /// PT.2 - Processing Mode.
        /// <para>Suggested: 0207 Processing Mode -&gt; ClearHl7.Codes.V260.CodeProcessingMode</para>
        /// </summary>
        ...
        public string ToDelimitedString()
        {
            ...
            return string.Format(
                                culture,
                                StringHelper.StringFormatSequence(0, 2, IsSubcomponent ? Configuration.SubcomponentSeparator : Configuration.ComponentSeparator),
                                ProcessingId,
                                ProcessingMode
