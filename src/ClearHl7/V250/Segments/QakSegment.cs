...
namespace ClearHl7.V250.Segments
{
    ...
    public class QakSegment : ISegment
    {
        ...
        /// <para>Suggested: 0208 Query Response Status -&gt; ClearHl7.Codes.V250.CodeQueryResponseStatus</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            MessageQueryName = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[3], false, seps) : null;
