...
namespace ClearHl7.V250.Segments
{
    ...
    public class PcrSegment : ISegment
    {
        ...
        /// </summary>
        public CodedElement ImplicatedProduct { get; set; }
        ...
        /// PCR.3 - Product Class.
        /// </summary>
        public CodedElement ProductClass { get; set; }
        ...
        /// </summary>
        public CodedElement IndicationForProductUse { get; set; }
        ...
        /// </summary>
        public CodedElement ProductEvaluationPerformed { get; set; }

        /// <summary>
        /// PCR.15 - Product Evaluation Status.
        /// <para>Suggested: 0247 Status Of Evaluation -&gt; ClearHl7.Codes.V250.CodeStatusOfEvaluation</para>
        /// </summary>
        ...
        /// </summary>
        public CodedElement ProductEvaluationResults { get; set; }

        /// <summary>
        /// PCR.17 - Evaluated Product Source.
        /// <para>Suggested: 0248 Product Source -&gt; ClearHl7.Codes.V250.CodeProductSource</para>
        /// </summary>
        ...
        /// <para>Suggested: 0250 Relatedness Assessment -&gt; ClearHl7.Codes.V250.CodeRelatednessAssessment</para>
        /// </summary>
        public string RelatednessAssessment { get; set; }

        /// <summary>
        /// PCR.21 - Action Taken In Response To The Event.
        /// <para>Suggested: 0251 Action Taken In Response To The Event -&gt; ClearHl7.Codes.V250.CodeActionTakenInResponseToTheEvent</para>
        /// </summary>
        public IEnumerable<string> ActionTakenInResponseToTheEvent { get; set; }

        /// <summary>
        /// PCR.22 - Event Causality Observations.
        /// <para>Suggested: 0252 Causality Observations -&gt; ClearHl7.Codes.V250.CodeCausalityObservations</para>
        /// </summary>
        public IEnumerable<string> EventCausalityObservations { get; set; }

        /// <summary>
        /// PCR.23 - Indirect Exposure Mechanism.
        /// <para>Suggested: 0253 Indirect Exposure Mechanism -&gt; ClearHl7.Codes.V250.CodeIndirectExposureMechanism</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ImplicatedProduct = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[1], false, seps) : null;
            GenericProduct = segments.Length > 2 && segments[2].Length > 0 ? segments[2] : null;
            ProductClass = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[3], false, seps) : null;
            ...
            IndicationForProductUse = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[10], false, seps) : null;
            ...
            ProductEvaluationPerformed = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[14], false, seps) : null;
            ProductEvaluationStatus = segments.Length > 15 && segments[15].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[15], false, seps) : null;
            ProductEvaluationResults = segments.Length > 16 && segments[16].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[16], false, seps) : null;
