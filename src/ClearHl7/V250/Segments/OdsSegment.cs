...
namespace ClearHl7.V250.Segments
{
    ...
    public class OdsSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            DietSupplementOrPreferenceCode = segments.Length > 3 ? segments.ElementAtOrDefault(3).Split(separator).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
