...
namespace ClearHl7.V250.Segments
{
    ...
    public class PidSegment : ISegment
    {
        ...
        /// <para>Suggested: 0445 Identity Reliability Code -&gt; ClearHl7.Codes.V250.CodeIdentityReliabilityCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0429 Production Class Code -&gt; ClearHl7.Codes.V250.CodeProductionClassCode</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            PatientAlias = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false)) : null;
