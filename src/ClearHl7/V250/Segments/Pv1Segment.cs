...
namespace ClearHl7.V250.Segments
{
    ...
    public class Pv1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            AmbulatoryStatus = segments.Length > 15 && segments[15].Length > 0 ? segments[15].Split(separator) : null;
            ...
            ContractCode = segments.Length > 24 && segments[24].Length > 0 ? segments[24].Split(separator) : null;
            ...
            DischargeDateTime = segments.Length > 45 && segments[45].Length > 0 ? segments[45].Split(separator).Select(x => x.ToDateTime()) : null;
            ...
            OtherHealthcareProvider = segments.Length > 52 && segments[52].Length > 0 ? segments[52].Split(separator).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false)) : null;
        }
