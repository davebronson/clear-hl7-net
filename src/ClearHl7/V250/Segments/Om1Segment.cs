...
namespace ClearHl7.V250.Segments
{
    ...
    public class Om1Segment : ISegment
    {
        ...
        /// <para>Suggested: 0174 Nature Of Service/Test/Observation -&gt; ClearHl7.Codes.V250.CodeNatureOfServiceTestObservation</para>
        /// </summary>
        ...
        /// <para>Suggested: 0168 Processing Priority -&gt; ClearHl7.Codes.V250.CodeProcessingPriority</para>
        /// </summary>
        public IEnumerable<string> ProcessingPriority { get; set; }

        /// <summary>
        /// OM1.26 - Reporting Priority.
        /// <para>Suggested: 0169 Reporting Priority -&gt; ClearHl7.Codes.V250.CodeReportingPriority</para>
        /// </summary>
        ...
        /// <para>Suggested: 0254 Kind Of Quantity -&gt; ClearHl7.Codes.V250.CodeKindOfQuantity</para>
        /// </summary>
        public CodedElement KindOfQuantityObserved { get; set; }

        /// <summary>
        /// OM1.43 - Point Versus Interval.
        /// <para>Suggested: 0255 Duration Categories -&gt; ClearHl7.Codes.V250.CodeDurationCategories</para>
        /// </summary>
        ...
        /// <para>Suggested: 0258 Relationship Modifier -&gt; ClearHl7.Codes.V250.CodeRelationshipModifier</para>
        /// </summary>
        ...
        /// <para>Suggested: 0259 Modality -&gt; ClearHl7.Codes.V250.CodeModality</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ProducersServiceTestObservationId = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[2], false) : null;
            ...
            ProducerId = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[5], false) : null;
            ObservationDescription = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<Text>(segments[6], false) : null;
            OtherServiceTestObservationIdsForTheObservation = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[7], false) : null;
            ...
            IdentityOfInstrumentUsedToPerformThisStudy = segments.Length > 13 && segments[13].Length > 0 ? segments[13].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            CodedRepresentationOfMethod = segments.Length > 14 && segments[14].Length > 0 ? segments[14].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            PortableDeviceIndicator = segments.Length > 15 && segments[15].Length > 0 ? segments[15] : null;
            ObservationProducingDepartmentSection = segments.Length > 16 && segments[16].Length > 0 ? segments[16].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            ReportSubheader = segments.Length > 19 && segments[19].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[19], false) : null;
            ...
            OutsideSitesWhereObservationMayBePerformed = segments.Length > 27 && segments[27].Length > 0 ? segments[27].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            ...
            ObservationsRequiredToInterpretThisObservation = segments.Length > 31 && segments[31].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[31], false) : null;
            InterpretationOfObservations = segments.Length > 32 && segments[32].Length > 0 ? TypeHelper.Deserialize<Text>(segments[32], false) : null;
            ContraindicationsToObservations = segments.Length > 33 && segments[33].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[33], false) : null;
            ReflexTestsObservations = segments.Length > 34 && segments[34].Length > 0 ? segments[34].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false)) : null;
            RulesThatTriggerReflexTesting = segments.Length > 35 && segments[35].Length > 0 ? TypeHelper.Deserialize<Text>(segments[35], false) : null;
            FixedCannedMessage = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[36], false) : null;
            PatientPreparation = segments.Length > 37 && segments[37].Length > 0 ? TypeHelper.Deserialize<Text>(segments[37], false) : null;
            ProcedureMedication = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[38], false) : null;
            ...
            KindOfQuantityObserved = segments.Length > 42 && segments[42].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[42], false) : null;
            PointVersusInterval = segments.Length > 43 && segments[43].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[43], false) : null;
            ChallengeInformation = segments.Length > 44 && segments[44].Length > 0 ? TypeHelper.Deserialize<Text>(segments[44], false) : null;
            RelationshipModifier = segments.Length > 45 && segments[45].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[45], false) : null;
            TargetAnatomicSiteOfTest = segments.Length > 46 && segments[46].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[46], false) : null;
            ModalityOfImagingMeasurement = segments.Length > 47 && segments[47].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[47], false) : null;
        }
