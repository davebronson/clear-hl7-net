...
namespace ClearHl7.V250.Segments
{
    ...
    public class Om1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ProducersServiceTestObservationId = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[2], false, seps) : null;
            ...
            ProducerId = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[5], false, seps) : null;
            ObservationDescription = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<Text>(segments[6], false, seps) : null;
            OtherServiceTestObservationIdsForTheObservation = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[7], false, seps) : null;
            ...
            IdentityOfInstrumentUsedToPerformThisStudy = segments.Length > 13 && segments[13].Length > 0 ? segments[13].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            CodedRepresentationOfMethod = segments.Length > 14 && segments[14].Length > 0 ? segments[14].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            PortableDeviceIndicator = segments.Length > 15 && segments[15].Length > 0 ? segments[15] : null;
            ObservationProducingDepartmentSection = segments.Length > 16 && segments[16].Length > 0 ? segments[16].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            ReportSubheader = segments.Length > 19 && segments[19].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[19], false, seps) : null;
            ...
            OutsideSitesWhereObservationMayBePerformed = segments.Length > 27 && segments[27].Length > 0 ? segments[27].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            ObservationsRequiredToInterpretThisObservation = segments.Length > 31 && segments[31].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[31], false, seps) : null;
            ...
            ContraindicationsToObservations = segments.Length > 33 && segments[33].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[33], false, seps) : null;
            ReflexTestsObservations = segments.Length > 34 && segments[34].Length > 0 ? segments[34].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            FixedCannedMessage = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[36], false, seps) : null;
            PatientPreparation = segments.Length > 37 && segments[37].Length > 0 ? TypeHelper.Deserialize<Text>(segments[37], false, seps) : null;
            ProcedureMedication = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[38], false, seps) : null;
            ...
            KindOfQuantityObserved = segments.Length > 42 && segments[42].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[42], false, seps) : null;
            PointVersusInterval = segments.Length > 43 && segments[43].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[43], false, seps) : null;
            ChallengeInformation = segments.Length > 44 && segments[44].Length > 0 ? TypeHelper.Deserialize<Text>(segments[44], false, seps) : null;
            RelationshipModifier = segments.Length > 45 && segments[45].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[45], false, seps) : null;
            TargetAnatomicSiteOfTest = segments.Length > 46 && segments[46].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[46], false, seps) : null;
            ModalityOfImagingMeasurement = segments.Length > 47 && segments[47].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[47], false, seps) : null;
        }
