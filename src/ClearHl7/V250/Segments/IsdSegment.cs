...
namespace ClearHl7.V250.Segments
{
    ...
    public class IsdSegment : ISegment
    {
        ...
        /// <para>Suggested: 0368 Remote Control Command -&gt; ClearHl7.Codes.V250.CodeRemoteControlCommand</para>
        /// </summary>
        public CodedElement InteractionTypeIdentifier { get; set; }

        /// <summary>
        /// ISD.3 - Interaction Active State.
        /// <para>Suggested: 0387 Command Response -&gt; ClearHl7.Codes.V250.CodeCommandResponse</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            InteractionTypeIdentifier = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[2], false, seps) : null;
            InteractionActiveState = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[3], false, seps) : null;
        }
