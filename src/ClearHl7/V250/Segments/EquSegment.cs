...
namespace ClearHl7.V250.Segments
{
    ...
    public class EquSegment : ISegment
    {
        ...
        /// <para>Suggested: 0365 Equipment State -&gt; ClearHl7.Codes.V250.CodeEquipmentState</para>
        /// </summary>
        public CodedElement EquipmentState { get; set; }

        /// <summary>
        /// EQU.4 - Local/Remote Control State.
        /// <para>Suggested: 0366 Local/Remote Control State -&gt; ClearHl7.Codes.V250.CodeLocalRemoteControlState</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            EquipmentInstanceIdentifier = segments.Length > 1 ? TypeHelper.Deserialize<EntityIdentifier>(segments.ElementAtOrDefault(1), false) : null;
            EventDateTime = segments.ElementAtOrDefault(2)?.ToNullableDateTime();
            EquipmentState = segments.Length > 3 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(3), false) : null;
            LocalRemoteControlState = segments.Length > 4 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(4), false) : null;
            AlertLevel = segments.Length > 5 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(5), false) : null;
        }
