...
namespace ClearHl7.V250.Segments
{
    ...
    public class BlcSegment : ISegment
    {
        ...
        /// <para>Suggested: 0426 Blood Product Code -&gt; ClearHl7.Codes.V250.CodeBloodProductCode</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            BloodProductCode = segments.Length > 1 && segments[1].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[1], false, seps) : null;
