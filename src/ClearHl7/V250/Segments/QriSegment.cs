...
namespace ClearHl7.V250.Segments
{
    ...
    public class QriSegment : ISegment
    {
        ...
        /// <para>Suggested: 0392 Match Reason -&gt; ClearHl7.Codes.V250.CodeMatchReason</para>
        /// </summary>
        public IEnumerable<string> MatchReasonCode { get; set; }

        /// <summary>
        /// QRI.3 - Algorithm Descriptor.
        /// <para>Suggested: 0393 Match Algorithms -&gt; ClearHl7.Codes.V250.CodeMatchAlgorithms</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            MatchReasonCode = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(separator) : null;
            AlgorithmDescriptor = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[3], false) : null;
        }
