...
namespace ClearHl7.V250.Segments
{
    ...
    public class QriSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            MatchReasonCode = segments.Length > 2 ? segments.ElementAtOrDefault(2).Split(separator) : null;
            AlgorithmDescriptor = segments.Length > 3 ? TypeHelper.Deserialize<CodedElement>(segments.ElementAtOrDefault(3), false) : null;
        }
