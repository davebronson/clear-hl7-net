...
namespace ClearHl7.V250.Segments
{
    ...
    public class SprSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            InputParameterList = segments.Length > 4 && segments[4].Length > 0 ? segments[4].Split(separator).Select(x => TypeHelper.Deserialize<QueryInputParameterList>(x, false)) : null;
        }
