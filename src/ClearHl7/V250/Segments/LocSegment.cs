...
namespace ClearHl7.V250.Segments
{
    ...
    public class LocSegment : ISegment
    {
        ...
        /// <para>Suggested: 0260 Patient Location Type -&gt; ClearHl7.Codes.V250.CodePatientLocationType</para>
        /// </summary>
        ...
        /// <para>Suggested: 0261 Location Equipment -&gt; ClearHl7.Codes.V250.CodeLocationEquipment</para>
        /// </summary>
        public IEnumerable<string> LocationEquipment { get; set; }

        /// <summary>
        /// LOC.9 - Location Service Code.
        /// <para>Suggested: 0442 Location Service Code -&gt; ClearHl7.Codes.V250.CodeLocationServiceCode</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            LicenseNumber = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            ...
            LocationServiceCode = segments.Length > 9 && segments[9].Length > 0 ? segments[9] : null;
        }
