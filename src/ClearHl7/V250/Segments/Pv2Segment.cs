...
namespace ClearHl7.V250.Segments
{
    ...
    public class Pv2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            ModeOfArrivalCode = segments.Length > 38 && segments[38].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[38], false, seps) : null;
            RecreationalDrugUseCode = segments.Length > 39 && segments[39].Length > 0 ? segments[39].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
            AdmissionLevelOfCareCode = segments.Length > 40 && segments[40].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[40], false, seps) : null;
            PrecautionCode = segments.Length > 41 && segments[41].Length > 0 ? segments[41].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
            PatientConditionCode = segments.Length > 42 && segments[42].Length > 0 ? TypeSerializer.Deserialize<CodedElement>(segments[42], false, seps) : null;
            ...
            AdvanceDirectiveCode = segments.Length > 45 && segments[45].Length > 0 ? segments[45].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeSerializer.Deserialize<CodedElement>(x, false, seps)) : null;
