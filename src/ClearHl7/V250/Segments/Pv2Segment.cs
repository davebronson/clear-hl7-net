...
namespace ClearHl7.V250.Segments
{
    ...
    public class Pv2Segment : ISegment
    {
        ...
        /// <para>Suggested: 0130 Visit User Code -&gt; ClearHl7.Codes.V250.CodeVisitUserCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0213 Purge Status Code -&gt; ClearHl7.Codes.V250.CodePurgeStatusCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0214 Special Program Code -&gt; ClearHl7.Codes.V250.CodeSpecialProgramCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0216 Patient Status Code -&gt; ClearHl7.Codes.V250.CodePatientStatusCode</para>
        /// </summary>
        public string PatientStatusCode { get; set; }

        /// <summary>
        /// PV2.25 - Visit Priority Code.
        /// <para>Suggested: 0217 Visit Priority Code -&gt; ClearHl7.Codes.V250.CodeVisitPriorityCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0430 Mode Of Arrival Code -&gt; ClearHl7.Codes.V250.CodeModeOfArrivalCode</para>
        /// </summary>
        public CodedElement ModeOfArrivalCode { get; set; }

        /// <summary>
        /// PV2.39 - Recreational Drug Use Code.
        /// <para>Suggested: 0431 Recreational Drug Use Code -&gt; ClearHl7.Codes.V250.CodeRecreationalDrugUseCode</para>
        /// </summary>
        public IEnumerable<CodedElement> RecreationalDrugUseCode { get; set; }

        /// <summary>
        /// PV2.40 - Admission Level of Care Code.
        /// <para>Suggested: 0432 Admission Level Of Care Code -&gt; ClearHl7.Codes.V250.CodeAdmissionLevelOfCareCode</para>
        /// </summary>
        public CodedElement AdmissionLevelOfCareCode { get; set; }

        /// <summary>
        /// PV2.41 - Precaution Code.
        /// <para>Suggested: 0433 Precaution Code -&gt; ClearHl7.Codes.V250.CodePrecautionCode</para>
        /// </summary>
        public IEnumerable<CodedElement> PrecautionCode { get; set; }

        /// <summary>
        /// PV2.42 - Patient Condition Code.
        /// <para>Suggested: 0434 Patient Condition Code -&gt; ClearHl7.Codes.V250.CodePatientConditionCode</para>
        /// </summary>
        public CodedElement PatientConditionCode { get; set; }

        /// <summary>
        /// PV2.43 - Living Will Code.
        /// <para>Suggested: 0315 Living Will Code -&gt; ClearHl7.Codes.V250.CodeLivingWillCode</para>
        /// </summary>
        public string LivingWillCode { get; set; }

        /// <summary>
        /// PV2.44 - Organ Donor Code.
        /// <para>Suggested: 0316 Organ Donor Code -&gt; ClearHl7.Codes.V250.CodeOrganDonorCode</para>
        /// </summary>
        public string OrganDonorCode { get; set; }

        /// <summary>
        /// PV2.45 - Advance Directive Code.
        /// <para>Suggested: 0435 Advance Directive Code -&gt; ClearHl7.Codes.V250.CodeAdvanceDirectiveCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0534 Notify Clergy Code -&gt; ClearHl7.Codes.V250.CodeNotifyClergyCode</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            AccommodationCode = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[2], false, seps) : null;
            AdmitReason = segments.Length > 3 && segments[3].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[3], false, seps) : null;
            TransferReason = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[4], false, seps) : null;
            ...
            PatientChargeAdjustmentCode = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[30], false, seps) : null;
            ...
            ModeOfArrivalCode = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[38], false, seps) : null;
            RecreationalDrugUseCode = segments.Length > 39 && segments[39].Length > 0 ? segments[39].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            AdmissionLevelOfCareCode = segments.Length > 40 && segments[40].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[40], false, seps) : null;
            PrecautionCode = segments.Length > 41 && segments[41].Length > 0 ? segments[41].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
            PatientConditionCode = segments.Length > 42 && segments[42].Length > 0 ? TypeHelper.Deserialize<CodedElement>(segments[42], false, seps) : null;
            ...
            AdvanceDirectiveCode = segments.Length > 45 && segments[45].Length > 0 ? segments[45].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedElement>(x, false, seps)) : null;
