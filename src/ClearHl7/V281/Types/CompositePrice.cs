...
namespace ClearHl7.V281.Types
{
    ...
    public class CompositePrice : IType
    {
        ...
        /// <summary>
        /// CP.2 - Price Type.
        /// <para>Suggested: 0205 Price Type -&gt; ClearHl7.Codes.V281.CodePriceType</para>
        /// </summary>
        ...
        /// <summary>
        /// CP.6 - Range Type.
        /// <para>Suggested: 0298 CP Range Type -&gt; ClearHl7.Codes.V281.CodeCpRangeType</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            Price = segments.Length > 0 && segments[0].Length > 0 ? TypeHelper.Deserialize<Money>(segments[0], true, seps) : null;
            ...
            RangeUnits = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[4], true, seps) : null;
