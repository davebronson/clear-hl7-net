...
namespace ClearHl7.V281.Segments
{
    ...
    public class ObrSegment : ISegment
    {
        ...
        /// <para>Suggested: 0065 Specimen Action Code -&gt; ClearHl7.Codes.V281.CodeSpecimenActionCode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0916 Relevant Clinicial Information -&gt; ClearHl7.Codes.V281.CodeRelevantClinicialInformation</para>
        /// </summary>
        ...
        /// <para>Suggested: 0123 Result Status -&gt; ClearHl7.Codes.V281.CodeResultStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0124 Transportation Mode -&gt; ClearHl7.Codes.V281.CodeTransportationMode</para>
        /// </summary>
        ...
        /// <para>Suggested: 0224 Transport Arranged -&gt; ClearHl7.Codes.V281.CodeTransportArranged</para>
        /// </summary>
        public string TransportArranged { get; set; }

        /// <summary>
        /// OBR.42 - Escort Required.
        /// <para>Suggested: 0225 Escort Required -&gt; ClearHl7.Codes.V281.CodeEscortRequired</para>
        /// </summary>
        ...
        /// <para>Suggested: 0411 Supplemental Service Information Values -&gt; ClearHl7.Codes.V281.CodeSupplementalServiceInformationValues</para>
        /// </summary>
        ...
        /// <para>Suggested: 0507 Observation Result Handling -&gt; ClearHl7.Codes.V281.CodeObservationResultHandling</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            RelevantClinicalInformation = segments.Length > 13 && segments[13].Length > 0 ? segments[13].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            QuantityTiming = segments.Length > 27 && segments[27].Length > 0 ? segments[27].Split(separator) : null;
            ...
            ReasonForStudy = segments.Length > 31 && segments[31].Length > 0 ? segments[31].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            TransportLogisticsOfCollectedSample = segments.Length > 38 && segments[38].Length > 0 ? segments[38].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            CollectorsComment = segments.Length > 39 && segments[39].Length > 0 ? segments[39].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            PlannedPatientTransportComment = segments.Length > 43 && segments[43].Length > 0 ? segments[43].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            ProcedureCodeModifier = segments.Length > 45 && segments[45].Length > 0 ? segments[45].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithNoExceptions>(x, false)) : null;
            PlacerSupplementalServiceInformation = segments.Length > 46 && segments[46].Length > 0 ? segments[46].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            FillerSupplementalServiceInformation = segments.Length > 47 && segments[47].Length > 0 ? segments[47].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            AlternatePlacerOrderNumber = segments.Length > 53 && segments[53].Length > 0 ? segments[53].Split(separator).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false)) : null;
            ParentOrder = segments.Length > 53 && segments[53].Length > 0 ? TypeHelper.Deserialize<EntityIdentifierPair>(segments[53], false) : null;
        }
