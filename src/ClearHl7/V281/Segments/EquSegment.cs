...
namespace ClearHl7.V281.Segments
{
    ...
    public class EquSegment : ISegment
    {
        ...
        /// <para>Suggested: 0365 Equipment State -&gt; ClearHl7.Fhir.Codes.V281.CodeEquipmentState</para>
        /// </summary>
        public CodedWithExceptions EquipmentState { get; set; }

        /// <summary>
        /// EQU.4 - Local/Remote Control State.
        /// <para>Suggested: 0366 Local/Remote Control State -&gt; ClearHl7.Fhir.Codes.V281.CodeLocalRemoteControlState</para>
        /// </summary>
        public CodedWithExceptions LocalRemoteControlState { get; set; }

        /// <summary>
        /// EQU.5 - Alert Level.
        /// <para>Suggested: 0367 Alert Level -&gt; ClearHl7.Fhir.Codes.V281.CodeAlertLevel</para>
        /// </summary>
