...
namespace ClearHl7.V281.Segments
{
    ...
    public class EquSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            EquipmentInstanceIdentifier = segments.Length > 1 && segments[1].Length > 0 ? segments[1].Split(separator).Select(x => TypeHelper.Deserialize<EntityIdentifier>(x, false)) : null;
