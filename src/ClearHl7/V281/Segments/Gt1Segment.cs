...
namespace ClearHl7.V281.Segments
{
    ...
    public class Gt1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            AmbulatoryStatus = segments.Length > 34 && segments[34].Length > 0 ? segments[34].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            Citizenship = segments.Length > 35 && segments[35].Length > 0 ? segments[35].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            EthnicGroup = segments.Length > 44 && segments[44].Length > 0 ? segments[44].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
            ...
            GuarantorRace = segments.Length > 55 && segments[55].Length > 0 ? segments[55].Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
