...
namespace ClearHl7.V281.Segments
{
    ...
    public class Gt1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            GuarantorNumber = segments.Length > 2 && segments[2].Length > 0 ? segments[2].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            GuarantorName = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            GuarantorSpouseName = segments.Length > 4 && segments[4].Length > 0 ? segments[4].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            GuarantorAddress = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedAddress>(x, false, seps)) : null;
            GuarantorPhNumHome = segments.Length > 6 && segments[6].Length > 0 ? segments[6].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            GuarantorPhNumBusiness = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            GuarantorDateTimeOfBirth = segments.Length > 8 && segments[8].Length > 0 ? segments[8].ToNullableDateTime() : null;
            GuarantorAdministrativeSex = segments.Length > 9 && segments[9].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[9], false, seps) : null;
            GuarantorType = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[10], false, seps) : null;
            GuarantorRelationship = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[11], false, seps) : null;
            ...
            GuarantorEmployerName = segments.Length > 16 && segments[16].Length > 0 ? segments[16].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            GuarantorEmployerAddress = segments.Length > 17 && segments[17].Length > 0 ? segments[17].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedAddress>(x, false, seps)) : null;
            GuarantorEmployerPhoneNumber = segments.Length > 18 && segments[18].Length > 0 ? segments[18].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            GuarantorEmployeeIdNumber = segments.Length > 19 && segments[19].Length > 0 ? segments[19].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            GuarantorEmploymentStatus = segments.Length > 20 && segments[20].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[20], false, seps) : null;
            GuarantorOrganizationName = segments.Length > 21 && segments[21].Length > 0 ? segments[21].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(x, false, seps)) : null;
            GuarantorBillingHoldFlag = segments.Length > 22 && segments[22].Length > 0 ? segments[22] : null;
            GuarantorCreditRatingCode = segments.Length > 23 && segments[23].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[23], false, seps) : null;
            ...
            GuarantorChargeAdjustmentCode = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[26], false, seps) : null;
            GuarantorHouseholdAnnualIncome = segments.Length > 27 && segments[27].Length > 0 ? TypeHelper.Deserialize<CompositePrice>(segments[27], false, seps) : null;
            GuarantorHouseholdSize = segments.Length > 28 && segments[28].Length > 0 ? segments[28].ToNullableDecimal() : null;
            GuarantorEmployerIdNumber = segments.Length > 29 && segments[29].Length > 0 ? segments[29].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            GuarantorMaritalStatusCode = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[30], false, seps) : null;
            ...
            LivingDependency = segments.Length > 33 && segments[33].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[33], false, seps) : null;
            AmbulatoryStatus = segments.Length > 34 && segments[34].Length > 0 ? segments[34].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            Citizenship = segments.Length > 35 && segments[35].Length > 0 ? segments[35].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            PrimaryLanguage = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[36], false, seps) : null;
            LivingArrangement = segments.Length > 37 && segments[37].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[37], false, seps) : null;
            PublicityCode = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[38], false, seps) : null;
            ProtectionIndicator = segments.Length > 39 && segments[39].Length > 0 ? segments[39] : null;
            StudentIndicator = segments.Length > 40 && segments[40].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[40], false, seps) : null;
            Religion = segments.Length > 41 && segments[41].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[41], false, seps) : null;
            MothersMaidenName = segments.Length > 42 && segments[42].Length > 0 ? segments[42].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            Nationality = segments.Length > 43 && segments[43].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[43], false, seps) : null;
            EthnicGroup = segments.Length > 44 && segments[44].Length > 0 ? segments[44].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ContactPersonsName = segments.Length > 45 && segments[45].Length > 0 ? segments[45].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            ContactPersonsTelephoneNumber = segments.Length > 46 && segments[46].Length > 0 ? segments[46].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            ContactReason = segments.Length > 47 && segments[47].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[47], false, seps) : null;
            ContactRelationship = segments.Length > 48 && segments[48].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[48], false, seps) : null;
            JobTitle = segments.Length > 49 && segments[49].Length > 0 ? segments[49] : null;
            JobCodeClass = segments.Length > 50 && segments[50].Length > 0 ? TypeHelper.Deserialize<JobCodeClass>(segments[50], false, seps) : null;
            GuarantorEmployersOrganizationName = segments.Length > 51 && segments[51].Length > 0 ? segments[51].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(x, false, seps)) : null;
            Handicap = segments.Length > 52 && segments[52].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[52], false, seps) : null;
            JobStatus = segments.Length > 53 && segments[53].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[53], false, seps) : null;
            GuarantorFinancialClass = segments.Length > 54 && segments[54].Length > 0 ? TypeHelper.Deserialize<FinancialClass>(segments[54], false, seps) : null;
            GuarantorRace = segments.Length > 55 && segments[55].Length > 0 ? segments[55].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            GuarantorBirthPlace = segments.Length > 56 && segments[56].Length > 0 ? segments[56] : null;
            VipIndicator = segments.Length > 57 && segments[57].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[57], false, seps) : null;
        }
