...
namespace ClearHl7.V281.Segments
{
    ...
    public class SpmSegment : ISegment
    {
        ...
        /// <summary>
        /// SPM.4 - Specimen Type.
        /// <para>Suggested: 0487 Specimen Type -&gt; ClearHl7.Codes.V281.CodeSpecimenType</para>
        /// </summary>
        ...
        /// <para>Suggested: 0488 Specimen Collection Method -&gt; ClearHl7.Codes.V281.CodeSpecimenCollectionMethod</para>
        /// </summary>
        ...
        /// <para>Suggested: 0369 Specimen Role -&gt; ClearHl7.Codes.V281.CodeSpecimenRole</para>
        /// </summary>
        ...
        /// <para>Suggested: 0490 Specimen Reject Reason -&gt; ClearHl7.Codes.V281.CodeSpecimenRejectReason</para>
        /// </summary>
        public IEnumerable<CodedWithExceptions> SpecimenRejectReason { get; set; }

        /// <summary>
        /// SPM.22 - Specimen Quality.
        /// <para>Suggested: 0491 Specimen Quality -&gt; ClearHl7.Codes.V281.CodeSpecimenQuality</para>
        /// </summary>
        public CodedWithExceptions SpecimenQuality { get; set; }

        /// <summary>
        /// SPM.23 - Specimen Appropriateness.
        /// <para>Suggested: 0492 Specimen Appropriateness -&gt; ClearHl7.Codes.V281.CodeSpecimenAppropriateness</para>
        /// </summary>
        public CodedWithExceptions SpecimenAppropriateness { get; set; }

        /// <summary>
        /// SPM.24 - Specimen Condition.
        /// <para>Suggested: 0493 Specimen Condition -&gt; ClearHl7.Codes.V281.CodeSpecimenCondition</para>
        /// </summary>
        ...
        /// <para>Suggested: 0494 Specimen Child Role -&gt; ClearHl7.Codes.V281.CodeSpecimenChildRole</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            SpecimenId = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<EntityIdentifierPair>(segments[2], false, seps) : null;
            SpecimenParentIds = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<EntityIdentifierPair>(x, false, seps)) : null;
            SpecimenType = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[4], false, seps) : null;
            SpecimenTypeModifier = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenAdditives = segments.Length > 6 && segments[6].Length > 0 ? segments[6].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenCollectionMethod = segments.Length > 7 && segments[7].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[7], false, seps) : null;
            SpecimenSourceSite = segments.Length > 8 && segments[8].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[8], false, seps) : null;
            SpecimenSourceSiteModifier = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenCollectionSite = segments.Length > 10 && segments[10].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[10], false, seps) : null;
            SpecimenRole = segments.Length > 11 && segments[11].Length > 0 ? segments[11].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenCollectionAmount = segments.Length > 12 && segments[12].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[12], false, seps) : null;
            ...
            SpecimenHandlingCode = segments.Length > 15 && segments[15].Length > 0 ? segments[15].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenRiskCode = segments.Length > 16 && segments[16].Length > 0 ? segments[16].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenCollectionDateTime = segments.Length > 17 && segments[17].Length > 0 ? TypeHelper.Deserialize<DateTimeRange>(segments[17], false, seps) : null;
            ...
            SpecimenRejectReason = segments.Length > 21 && segments[21].Length > 0 ? segments[21].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenQuality = segments.Length > 22 && segments[22].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[22], false, seps) : null;
            SpecimenAppropriateness = segments.Length > 23 && segments[23].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[23], false, seps) : null;
            SpecimenCondition = segments.Length > 24 && segments[24].Length > 0 ? segments[24].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            SpecimenCurrentQuantity = segments.Length > 25 && segments[25].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[25], false, seps) : null;
            NumberOfSpecimenContainers = segments.Length > 26 && segments[26].Length > 0 ? segments[26].ToNullableDecimal() : null;
            ContainerType = segments.Length > 27 && segments[27].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[27], false, seps) : null;
            ContainerCondition = segments.Length > 28 && segments[28].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[28], false, seps) : null;
            SpecimenChildRole = segments.Length > 29 && segments[29].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[29], false, seps) : null;
            AccessionId = segments.Length > 30 && segments[30].Length > 0 ? segments[30].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            OtherSpecimenId = segments.Length > 31 && segments[31].Length > 0 ? segments[31].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            ShipmentId = segments.Length > 32 && segments[32].Length > 0 ? TypeHelper.Deserialize<EntityIdentifier>(segments[32], false, seps) : null;
        }
