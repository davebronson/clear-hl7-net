...
namespace ClearHl7.V281.Segments
{
    ...
    public class SpmSegment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            AccessionId = segments.Length > 30 && segments[30].Length > 0 ? segments[30].Split(separator).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false)) : null;
            OtherSpecimenId = segments.Length > 31 && segments[31].Length > 0 ? segments[31].Split(separator).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false)) : null;
