...
namespace ClearHl7.V281.Segments
{
    ...
    public class Rq1Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ManufacturerIdentifier = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[2], false) : null;
            ManufacturersCatalog = segments.Length > 3 && segments[3].Length > 0 ? segments[3] : null;
            VendorId = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[4], false) : null;
