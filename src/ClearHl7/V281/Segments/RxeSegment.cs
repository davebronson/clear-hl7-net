...
namespace ClearHl7.V281.Segments
{
    ...
    public class RxeSegment : ISegment
    {
        ...
        /// <para>Suggested: 0477 Controlled Substance Schedule -&gt; ClearHl7.Fhir.Codes.V281.CodeControlledSubstanceSchedule</para>
        /// </summary>
        public CodedWithExceptions ControlledSubstanceSchedule { get; set; }

        /// <summary>
        /// RXE.36 - Formulary Status.
        /// <para>Suggested: 0478 Formulary Status -&gt; ClearHl7.Fhir.Codes.V281.CodeFormularyStatus</para>
        /// </summary>
