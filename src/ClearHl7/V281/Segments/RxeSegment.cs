...
namespace ClearHl7.V281.Segments
{
    ...
    public class RxeSegment : ISegment
    {
        ...
        /// <summary>
        /// RXE.2 - Give Code.
        /// <para>Suggested: 0292 Vaccines Administered -&gt; ClearHl7.Codes.V281.CodeVaccinesAdministered</para>
        /// </summary>
        ...
        /// <para>Suggested: 0167 Substitution Status -&gt; ClearHl7.Codes.V281.CodeSubstitutionStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0321 Dispense Method -&gt; ClearHl7.Codes.V281.CodeDispenseMethod</para>
        /// </summary>
        ...
        /// <para>Suggested: 0477 Controlled Substance Schedule -&gt; ClearHl7.Codes.V281.CodeControlledSubstanceSchedule</para>
        /// </summary>
        public CodedWithExceptions ControlledSubstanceSchedule { get; set; }

        /// <summary>
        /// RXE.36 - Formulary Status.
        /// <para>Suggested: 0478 Formulary Status -&gt; ClearHl7.Codes.V281.CodeFormularyStatus</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            GiveCode = segments.Length > 2 && segments[2].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[2], false, seps) : null;
            ...
            GiveUnits = segments.Length > 5 && segments[5].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[5], false, seps) : null;
            GiveDosageForm = segments.Length > 6 && segments[6].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[6], false, seps) : null;
            ProvidersAdministrationInstructions = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            DispenseUnits = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[11], false, seps) : null;
            NumberOfRefills = segments.Length > 12 && segments[12].Length > 0 ? segments[12].ToNullableDecimal() : null;
            OrderingProvidersDeaNumber = segments.Length > 13 && segments[13].Length > 0 ? segments[13].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            PharmacistTreatmentSuppliersVerifierId = segments.Length > 14 && segments[14].Length > 0 ? segments[14].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            ...
            TotalDailyDose = segments.Length > 19 && segments[19].Length > 0 ? TypeHelper.Deserialize<CompositeQuantityWithUnits>(segments[19], false, seps) : null;
            NeedsHumanReview = segments.Length > 20 && segments[20].Length > 0 ? segments[20] : null;
            SpecialDispensingInstructions = segments.Length > 21 && segments[21].Length > 0 ? segments[21].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            GiveRateUnits = segments.Length > 24 && segments[24].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[24], false, seps) : null;
            GiveStrength = segments.Length > 25 && segments[25].Length > 0 ? segments[25].ToNullableDecimal() : null;
            GiveStrengthUnits = segments.Length > 26 && segments[26].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[26], false, seps) : null;
            GiveIndication = segments.Length > 27 && segments[27].Length > 0 ? segments[27].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            DispensePackageSize = segments.Length > 28 && segments[28].Length > 0 ? segments[28].ToNullableDecimal() : null;
            DispensePackageSizeUnit = segments.Length > 29 && segments[29].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[29], false, seps) : null;
            DispensePackageMethod = segments.Length > 30 && segments[30].Length > 0 ? segments[30] : null;
            SupplementaryCode = segments.Length > 31 && segments[31].Length > 0 ? segments[31].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            GiveDrugStrengthVolumeUnits = segments.Length > 34 && segments[34].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[34], false, seps) : null;
            ControlledSubstanceSchedule = segments.Length > 35 && segments[35].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[35], false, seps) : null;
            FormularyStatus = segments.Length > 36 && segments[36].Length > 0 ? segments[36] : null;
            PharmaceuticalSubstanceAlternative = segments.Length > 37 && segments[37].Length > 0 ? segments[37].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            PharmacyOfMostRecentFill = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[38], false, seps) : null;
            InitialDispenseAmount = segments.Length > 39 && segments[39].Length > 0 ? segments[39].ToNullableDecimal() : null;
            DispensingPharmacy = segments.Length > 40 && segments[40].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[40], false, seps) : null;
            DispensingPharmacyAddress = segments.Length > 41 && segments[41].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[41], false, seps) : null;
            DeliverToPatientLocation = segments.Length > 42 && segments[42].Length > 0 ? TypeHelper.Deserialize<PersonLocation>(segments[42], false, seps) : null;
            DeliverToAddress = segments.Length > 43 && segments[43].Length > 0 ? TypeHelper.Deserialize<ExtendedAddress>(segments[43], false, seps) : null;
            PharmacyOrderType = segments.Length > 44 && segments[44].Length > 0 ? segments[44] : null;
            PharmacyPhoneNumber = segments.Length > 45 && segments[45].Length > 0 ? segments[45].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
        }
