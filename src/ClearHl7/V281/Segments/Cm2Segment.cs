...
namespace ClearHl7.V281.Segments
{
    ...
    public class Cm2Segment : ISegment
    {
        ...
        public void FromDelimitedString(string delimitedString)
        {
            ...
            ScheduledTimePoint = segments.Length > 2 ? TypeHelper.Deserialize<CodedWithExceptions>(segments.ElementAtOrDefault(2), false) : null;
            DescriptionOfTimePoint = segments.ElementAtOrDefault(3);
            EventsScheduledThisTimePoint = segments.Length > 4 ? segments.ElementAtOrDefault(4).Split(separator).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false)) : null;
        }
