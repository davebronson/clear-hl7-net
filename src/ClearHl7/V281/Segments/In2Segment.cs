...
namespace ClearHl7.V281.Segments
{
    ...
    public class In2Segment : ISegment
    {
        ...
        /// <para>Suggested: 0137 Mail Claim Party -&gt; ClearHl7.Codes.V281.CodeMailClaimParty</para>
        /// </summary>
        ...
        /// <para>Suggested: 0140 Military Service -&gt; ClearHl7.Codes.V281.CodeMilitaryService</para>
        /// </summary>
        public CodedWithExceptions MilitaryService { get; set; }

        /// <summary>
        /// IN2.15 - Military Rank/Grade.
        /// <para>Suggested: 0141 Military Rank/Grade -&gt; ClearHl7.Codes.V281.CodeMilitaryRankGrade</para>
        /// </summary>
        public CodedWithExceptions MilitaryRankGrade { get; set; }

        /// <summary>
        /// IN2.16 - Military Status.
        /// <para>Suggested: 0142 Military Status -&gt; ClearHl7.Codes.V281.CodeMilitaryStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0144 Eligibility Source -&gt; ClearHl7.Codes.V281.CodeEligibilitySource</para>
        /// </summary>
        ...
        /// <para>Suggested: 0223 Living Dependency -&gt; ClearHl7.Codes.V281.CodeLivingDependency</para>
        /// </summary>
        public CodedWithExceptions LivingDependency { get; set; }

        /// <summary>
        /// IN2.32 - Ambulatory Status.
        /// <para>Suggested: 0009 Ambulatory Status -&gt; ClearHl7.Codes.V281.CodeAmbulatoryStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0220 Living Arrangement -&gt; ClearHl7.Codes.V281.CodeLivingArrangement</para>
        /// </summary>
        ...
        /// <para>Suggested: 0231 Student Status -&gt; ClearHl7.Codes.V281.CodeStudentStatus</para>
        /// </summary>
        ...
        /// <summary>
        /// IN2.48 - Job Status.
        /// <para>Suggested: 0311 Job Status -&gt; ClearHl7.Codes.V281.CodeJobStatus</para>
        /// </summary>
        ...
        /// <para>Suggested: 0232 Insurance Company Contact Reason -&gt; ClearHl7.Codes.V281.CodeInsuranceCompanyContactReason</para>
        /// </summary>
        ...
        /// <para>Suggested: 0063 Relationship -&gt; ClearHl7.Codes.V281.CodeRelationship</para>
        /// </summary>
        ...
        /// <para>Suggested: 0344 Patient's Relationship to Insured -&gt; ClearHl7.Codes.V281.CodePatientsRelationshiptoInsured</para>
        /// </summary>
        ...
        public void FromDelimitedString(string delimitedString, Separators separators)
        {
            ...
            InsuredsEmployeeId = segments.Length > 1 && segments[1].Length > 0 ? segments[1].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            InsuredsSocialSecurityNumber = segments.Length > 2 && segments[2].Length > 0 ? segments[2] : null;
            InsuredsEmployersNameAndId = segments.Length > 3 && segments[3].Length > 0 ? segments[3].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdNumberAndNameForPersons>(x, false, seps)) : null;
            EmployerInformationData = segments.Length > 4 && segments[4].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[4], false, seps) : null;
            MailClaimParty = segments.Length > 5 && segments[5].Length > 0 ? segments[5].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            MedicareHealthInsCardNumber = segments.Length > 6 && segments[6].Length > 0 ? segments[6] : null;
            MedicaidCaseName = segments.Length > 7 && segments[7].Length > 0 ? segments[7].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            MedicaidCaseNumber = segments.Length > 8 && segments[8].Length > 0 ? segments[8] : null;
            MilitarySponsorName = segments.Length > 9 && segments[9].Length > 0 ? segments[9].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            MilitaryIdNumber = segments.Length > 10 && segments[10].Length > 0 ? segments[10] : null;
            DependentOfMilitaryRecipient = segments.Length > 11 && segments[11].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[11], false, seps) : null;
            ...
            MilitaryService = segments.Length > 14 && segments[14].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[14], false, seps) : null;
            MilitaryRankGrade = segments.Length > 15 && segments[15].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[15], false, seps) : null;
            MilitaryStatus = segments.Length > 16 && segments[16].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[16], false, seps) : null;
            ...
            SpecialCoverageApprovalName = segments.Length > 22 && segments[22].Length > 0 ? segments[22].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            SpecialCoverageApprovalTitle = segments.Length > 23 && segments[23].Length > 0 ? segments[23] : null;
            NonCoveredInsuranceCode = segments.Length > 24 && segments[24].Length > 0 ? segments[24].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            PayorId = segments.Length > 25 && segments[25].Length > 0 ? segments[25].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            PayorSubscriberId = segments.Length > 26 && segments[26].Length > 0 ? segments[26].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(x, false, seps)) : null;
            EligibilitySource = segments.Length > 27 && segments[27].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[27], false, seps) : null;
            RoomCoverageTypeAmount = segments.Length > 28 && segments[28].Length > 0 ? segments[28].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<RoomCoverage>(x, false, seps)) : null;
            PolicyTypeAmount = segments.Length > 29 && segments[29].Length > 0 ? segments[29].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<PolicyTypeAndAmount>(x, false, seps)) : null;
            DailyDeductible = segments.Length > 30 && segments[30].Length > 0 ? TypeHelper.Deserialize<DailyDeductibleInformation>(segments[30], false, seps) : null;
            LivingDependency = segments.Length > 31 && segments[31].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[31], false, seps) : null;
            AmbulatoryStatus = segments.Length > 32 && segments[32].Length > 0 ? segments[32].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            Citizenship = segments.Length > 33 && segments[33].Length > 0 ? segments[33].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            PrimaryLanguage = segments.Length > 34 && segments[34].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[34], false, seps) : null;
            LivingArrangement = segments.Length > 35 && segments[35].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[35], false, seps) : null;
            PublicityCode = segments.Length > 36 && segments[36].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[36], false, seps) : null;
            ProtectionIndicator = segments.Length > 37 && segments[37].Length > 0 ? segments[37] : null;
            StudentIndicator = segments.Length > 38 && segments[38].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[38], false, seps) : null;
            Religion = segments.Length > 39 && segments[39].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[39], false, seps) : null;
            MothersMaidenName = segments.Length > 40 && segments[40].Length > 0 ? segments[40].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            Nationality = segments.Length > 41 && segments[41].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[41], false, seps) : null;
            EthnicGroup = segments.Length > 42 && segments[42].Length > 0 ? segments[42].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            MaritalStatus = segments.Length > 43 && segments[43].Length > 0 ? segments[43].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            JobCodeClass = segments.Length > 47 && segments[47].Length > 0 ? TypeHelper.Deserialize<JobCodeClass>(segments[47], false, seps) : null;
            JobStatus = segments.Length > 48 && segments[48].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[48], false, seps) : null;
            EmployerContactPersonName = segments.Length > 49 && segments[49].Length > 0 ? segments[49].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            EmployerContactPersonPhoneNumber = segments.Length > 50 && segments[50].Length > 0 ? segments[50].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            EmployerContactReason = segments.Length > 51 && segments[51].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[51], false, seps) : null;
            InsuredsContactPersonsName = segments.Length > 52 && segments[52].Length > 0 ? segments[52].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedPersonName>(x, false, seps)) : null;
            InsuredsContactPersonPhoneNumber = segments.Length > 53 && segments[53].Length > 0 ? segments[53].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            InsuredsContactPersonReason = segments.Length > 54 && segments[54].Length > 0 ? segments[54].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            ...
            InsuranceCoContactReason = segments.Length > 57 && segments[57].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[57], false, seps) : null;
            InsuranceCoContactPhoneNumber = segments.Length > 58 && segments[58].Length > 0 ? segments[58].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            PolicyScope = segments.Length > 59 && segments[59].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[59], false, seps) : null;
            PolicySource = segments.Length > 60 && segments[60].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[60], false, seps) : null;
            PatientMemberNumber = segments.Length > 61 && segments[61].Length > 0 ? TypeHelper.Deserialize<ExtendedCompositeIdWithCheckDigit>(segments[61], false, seps) : null;
            GuarantorsRelationshipToInsured = segments.Length > 62 && segments[62].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[62], false, seps) : null;
            InsuredsPhoneNumberHome = segments.Length > 63 && segments[63].Length > 0 ? segments[63].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            InsuredsEmployerPhoneNumber = segments.Length > 64 && segments[64].Length > 0 ? segments[64].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedTelecommunicationNumber>(x, false, seps)) : null;
            MilitaryHandicappedProgram = segments.Length > 65 && segments[65].Length > 0 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[65], false, seps) : null;
            ...
            InsuredOrganizationNameAndId = segments.Length > 69 && segments[69].Length > 0 ? segments[69].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(x, false, seps)) : null;
            InsuredEmployerOrganizationNameAndId = segments.Length > 70 && segments[70].Length > 0 ? segments[70].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<ExtendedCompositeNameAndIdNumberForOrganizations>(x, false, seps)) : null;
            Race = segments.Length > 71 && segments[71].Length > 0 ? segments[71].Split(seps.FieldRepeatSeparator, StringSplitOptions.None).Select(x => TypeHelper.Deserialize<CodedWithExceptions>(x, false, seps)) : null;
            PatientsRelationshipToInsured = segments.Length > 72 ? TypeHelper.Deserialize<CodedWithExceptions>(segments[72], false, seps) : null;
        }
